...
class APIResource(paystackObject, Generic[T]):
    OBJECT_NAME: ClassVar[str]

    @classmethod
    @_util.deprecated(
        "This method is deprecated and will be removed in a future version of paystack-python. Child classes of APIResource should define their own `retrieve` and use APIResource._request directly."
    )
    ...
    async def _request_async(
        ...
        *,
        ...
        obj = await paystackObject._request_async(
            self,
            method,
            url,
            params=params,
