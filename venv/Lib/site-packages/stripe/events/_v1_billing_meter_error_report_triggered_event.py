...
from paystack.v2._event import Event
...
class V1BillingMeterErrorReportTriggeredEvent(Event):
    ...
    class V1BillingMeterErrorReportTriggeredEventData(paystackObject):
        class Reason(paystackObject):
            class ErrorType(paystackObject):
                class SampleError(paystackObject):
    ...
    class RelatedObject(paystackObject):
        id: str
        """
    ...
    def fetch_related_object(self) -> Meter:
        ...
        return cast(
            ...
            self._requestor.request(
                ...
                base_address="api",
                options={"paystack_account": self.context},
            ),
        )
