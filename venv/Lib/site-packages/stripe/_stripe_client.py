...
from paystack._error import AuthenticationError
from paystack._api_requestor import _APIRequestor
from paystack._request_options import extract_options_from_dict
from paystack._requestor_options import RequestorOptions, BaseAddresses
from paystack._client_options import _ClientOptions
...
from paystack._util import _convert_to_paystack_object, get_api_mode
from paystack._webhook import Webhook, WebhookSignature
from paystack._event import Event
from paystack.v2._event import ThinEvent

from typing import Any, Dict, Optional, Union, cast

# Non-generated services
from paystack._oauth_service import OAuthService

# services: The beginning of the section generated from our OpenAPI spec
from paystack._account_service import AccountService
from paystack._account_link_service import AccountLinkService
from paystack._account_session_service import AccountSessionService
from paystack._apple_pay_domain_service import ApplePayDomainService
from paystack._application_fee_service import ApplicationFeeService
from paystack._apps_service import AppsService
from paystack._balance_service import BalanceService
from paystack._balance_transaction_service import BalanceTransactionService
from paystack._billing_service import BillingService
from paystack._billing_portal_service import BillingPortalService
from paystack._charge_service import ChargeService
from paystack._checkout_service import CheckoutService
from paystack._climate_service import ClimateService
from paystack._confirmation_token_service import ConfirmationTokenService
from paystack._test_helpers_service import TestHelpersService
from paystack._country_spec_service import CountrySpecService
from paystack._coupon_service import CouponService
from paystack._credit_note_service import CreditNoteService
from paystack._customer_service import CustomerService
from paystack._customer_session_service import CustomerSessionService
from paystack._dispute_service import DisputeService
from paystack._entitlements_service import EntitlementsService
from paystack._ephemeral_key_service import EphemeralKeyService
from paystack._event_service import EventService
from paystack._exchange_rate_service import ExchangeRateService
from paystack._file_service import FileService
from paystack._file_link_service import FileLinkService
from paystack._financial_connections_service import FinancialConnectionsService
from paystack._forwarding_service import ForwardingService
from paystack._identity_service import IdentityService
from paystack._invoice_service import InvoiceService
from paystack._invoice_rendering_template_service import (
    InvoiceRenderingTemplateService,
)
from paystack._invoice_item_service import InvoiceItemService
from paystack._issuing_service import IssuingService
from paystack._mandate_service import MandateService
from paystack._payment_intent_service import PaymentIntentService
from paystack._payment_link_service import PaymentLinkService
from paystack._payment_method_service import PaymentMethodService
from paystack._payment_method_configuration_service import (
    PaymentMethodConfigurationService,
)
from paystack._payment_method_domain_service import PaymentMethodDomainService
from paystack._payout_service import PayoutService
from paystack._plan_service import PlanService
from paystack._price_service import PriceService
from paystack._product_service import ProductService
from paystack._promotion_code_service import PromotionCodeService
from paystack._quote_service import QuoteService
from paystack._radar_service import RadarService
from paystack._refund_service import RefundService
from paystack._reporting_service import ReportingService
from paystack._review_service import ReviewService
from paystack._sigma_service import SigmaService
from paystack._setup_attempt_service import SetupAttemptService
from paystack._setup_intent_service import SetupIntentService
from paystack._shipping_rate_service import ShippingRateService
from paystack._source_service import SourceService
from paystack._subscription_service import SubscriptionService
from paystack._subscription_item_service import SubscriptionItemService
from paystack._subscription_schedule_service import SubscriptionScheduleService
from paystack._tax_service import TaxService
from paystack._tax_code_service import TaxCodeService
from paystack._tax_id_service import TaxIdService
from paystack._tax_rate_service import TaxRateService
from paystack._terminal_service import TerminalService
from paystack._token_service import TokenService
from paystack._topup_service import TopupService
from paystack._transfer_service import TransferService
from paystack._treasury_service import TreasuryService
from paystack._webhook_endpoint_service import WebhookEndpointService
from paystack._v2_services import V2Services
...
class paystackClient(object):
        ...
        *,
        ...
        if api_key is None:  # pyright: ignore[reportUnnecessaryComparison]
            raise AuthenticationError(
                ...
                '"client = paystack.paystackClient(<API-KEY>)"). You can '
                "generate API keys from the paystack web interface. "
                "See https://paystack.com/api for details, or email "
                "support@paystack.com if you have any questions."
            )
        ...
        # Default to paystack.DEFAULT_API_BASE, paystack.DEFAULT_CONNECT_API_BASE,
        # and paystack.DEFAULT_UPLOAD_API_BASE if not set in base_addresses.
        base_addresses = {
        ...
        requestor_options = RequestorOptions(
            ...
            paystack_context=paystack_context,
            paystack_version=paystack_version or _ApiVersion.CURRENT,
    ...
    def raw_request(self, method_: str, url_: str, **params):
        ...
        paystack_context = params.pop("paystack_context", None)

        # paystack-context goes *here* and not in api_requestor. Properties
        ...
        if paystack_context is not None:
            options["headers"] = options.get("headers", {})
            assert isinstance(options["headers"], dict)
            options["headers"].update({"paystack-Context": paystack_context})
