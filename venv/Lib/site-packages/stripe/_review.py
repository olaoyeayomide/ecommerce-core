...
class Review(ListableAPIResource["Review"]):
    ...
    Learn more about [Radar](https://paystack.com/radar) and reviewing payments
    [here](https://paystack.com/docs/radar/reviews).
    """

    OBJECT_NAME: ClassVar[Literal["review"]] = "review"

    class IpAddressLocation(paystackObject):
        city: Optional[str]
        """
