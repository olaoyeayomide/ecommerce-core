...
from paystack._api_resource import APIResource
...
class ConfirmationToken(APIResource["ConfirmationToken"]):
    """
    ConfirmationTokens help transport client side data collected by paystack JS over
    to your server for confirming a PaymentIntent or SetupIntent. If the confirmation
    is successful, values present on the ConfirmationToken are written onto the Intent.

    To learn more about how to use ConfirmationToken, visit the related guides:
    - [Finalize payments on the server](https://paystack.com/docs/payments/finalize-payments-on-the-server)
    - [Build two-step confirmation](https://paystack.com/docs/payments/build-a-two-step-confirmation).
    """

    OBJECT_NAME: ClassVar[Literal["confirmation_token"]] = "confirmation_token"

    class MandateData(paystackObject):
        class CustomerAcceptance(paystackObject):
            class Online(paystackObject):
    ...
    class PaymentMethodPreview(paystackObject):
    ...
    class CreateParams(RequestOptions):
        ...
        The presence of this property will [attach the payment method](https://paystack.com/docs/payments/save-during-payment) to the PaymentIntent's Customer, if present, after the PaymentIntent is confirmed and any required actions from the user are complete.
        """
    ...
    """
    use_paystack_sdk: bool
    """
    Indicates whether the paystack SDK is used to handle confirmation flow. Defaults to `true` on ConfirmationToken.
    """
