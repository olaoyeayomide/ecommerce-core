...
from paystack._error import InvalidRequestError
...
if TYPE_CHECKING:
    from paystack._source_transaction import SourceTransaction


class Source(CreateableAPIResource["Source"], UpdateableAPIResource["Source"]):
    """
    `Source` objects allow you to accept a variety of payment methods. They
    represent a customer's payment instrument, and can be used with the paystack API
    just like a `Card` object: once chargeable, they can be charged, or can be
    attached to customers.

    paystack doesn't recommend using the deprecated [Sources API](https://paystack.com/docs/api/sources).
    We recommend that you adopt the [PaymentMethods API](https://paystack.com/docs/api/payment_methods).
    This newer API provides access to our latest features and payment method types.

    Related guides: [Sources API](https://paystack.com/docs/sources) and [Sources & Customers](https://paystack.com/docs/sources/customers).
    """
    ...
    class CodeVerification(paystackObject):
    ...
    class Owner(paystackObject):
        ...
        class VerifiedAddress(paystackObject):
            city: Optional[str]
            """
            City, district, suburb, town, or village.
            """
    ...
    class SourceOrder(paystackObject):
    ...
    class CreateParams(RequestOptions):
        ...
        """
        Three-letter [ISO code for the currency](https://paystack.com/docs/currencies) associated with the source. This is the currency for which the source will be chargeable once ready.
        """
        ...
        """
        The `type` of the source to create. Required unless `customer` and `original_source` are specified (see the [Cloning card Sources](https://paystack.com/docs/sources/connect#cloning-card-sources) guide)
        """
    ...
    class CreateParamsMandate(TypedDict):
        ...
        """
        The parameters required to notify paystack of a mandate acceptance or refusal by the customer.
        """
        ...
        notification_method: NotRequired[
            Literal[
                "deprecated_none", "email", "manual", "none", "paystack_email"
            ]
        ]
        """
    ...
    currency: Optional[str]
    """
    Three-letter [ISO code for the currency](https://paystack.com/docs/currencies) associated with the source. This is the currency for which the source will be chargeable once ready. Required for `single_use` sources.
    """
    customer: Optional[str]
    """
    ...
    def modify(
        ...
        This request accepts the metadata and owner as arguments. It is also possible to update type specific information for selected payment methods. Please refer to our [payment method guides](https://paystack.com/docs/sources) for more detail.
        """
    ...
    def retrieve(
        ...
        """
        Retrieves an existing source object. Supply the unique source ID from a source creation request and paystack will return the corresponding up-to-date source object information.
        """
