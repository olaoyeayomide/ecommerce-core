...
class ApplicationFee(ListableAPIResource["ApplicationFee"]):
    ...
    class FeeSource(paystackObject):
        charge: Optional[str]
        """
    ...
    """
    ID of the paystack account this fee was taken from.
    """
    amount: int
    """
    ...
    def _cls_refund(
        ...
        Funds will be refunded to the paystack account from which the fee was originally collected.
