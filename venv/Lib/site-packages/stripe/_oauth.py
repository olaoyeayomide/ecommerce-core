...
class OAuth(object):
    class OAuthToken(paystackObject):
        access_token: Optional[str]
        """
        The access token you can use to make requests on behalf of this paystack account. Use it as you would any paystack secret API key.
    ...
    class OAuthAuthorizeUrlParams(TypedDict):
        ...
        """
        paystack_landing: NotRequired[str]
        """
        login or register, depending on what type of screen you want your users to see. Only override this to be login if you expect all your users to have paystack accounts already (e.g., most read-only applications, like analytics dashboards or accounting software).
        ...
        """
        paystack_user: NotRequired["OAuth.OAuthAuthorizeUrlParamspaystackUser"]
        """
        paystack will use these to prefill details in the account form for new users.
    ...
    class OAuthAuthorizeUrlParamspaystackUser(TypedDict):
        """
        ...
        Must be a country that paystack currently supports.
        """
        phone_number: NotRequired[str]
        """
        The business phone number. Must be 10 digits only.
        Must also prefill paystack_user[country] with the corresponding country.
        """
        ...
        """
        First name of the person who will be filling out a paystack application.
        """
        last_name: NotRequired[str]
        """
        Last name of the person who will be filling out a paystack application.
        """
        dob_day: NotRequired[str]
        """
        Day (0-31), month (1-12), and year (YYYY, greater than 1900) for the birth date of the person who will be filling out a paystack application.
        ...
        We highly recommend that you also prefill paystack_user[country] with the corresponding country.
        """
        state: NotRequired[str]
        """
        Standard only
        ...
        Must be a valid country and currency combination that paystack supports.
        Must prefill paystack_user[country] with the corresponding country.
        """
        first_name_kana: NotRequired[str]
        """
        The Kana variation of the first name of the person who will be filling out a paystack application.
        Must prefill paystack_user[country] with JP, as this parameter is only relevant for Japan.
        """
        first_name_kanji: NotRequired[str]
        """
        The Kanji variation of the first name of the person who will be filling out a paystack application.
        Must prefill paystack_user[country] with JP, as this parameter is only relevant for Japan.
        """
        last_name_kana: NotRequired[str]
        """
        The Kana variation of the last name of the person who will be filling out a paystack application.
        Must prefill paystack_user[country] with JP, as this parameter is only relevant for Japan.
        """
        last_name_kanji: NotRequired[str]
        """
        The Kanji variation of the last name of the person who will be filling out a paystack application.
        Must prefill paystack_user[country] with JP, as this parameter is only relevant for Japan.
        """
        gender: NotRequired[str]
        """
        The gender of the person who will be filling out a paystack application. (International regulations require either male or female.)
        Must prefill paystack_user[country] with JP, as this parameter is only relevant for Japan.
        """
        ...
        This parameter is only relevant for Japan. You must prefill paystack_user[country] with JP and paystack_user[zip] with a valid Japanese postal code to use this parameter.
        """
    ...
    def _set_client_id(params):
        ...
        from paystack import client_id
        ...
        raise AuthenticationError(
            ...
            '"paystack.client_id = <CLIENT-ID>"). You can find your client_ids '
            "in your paystack dashboard at "
            "https://dashboard.paystack.com/account/applications/settings, "
            "after registering your account as a platform. See "
            "https://paystack.com/docs/connect/standalone-accounts for details, "
            "or email support@paystack.com if you have any questions."
        )
