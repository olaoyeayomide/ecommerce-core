...
from paystack._test_helpers import APIResourceTestHelpers
...
if TYPE_CHECKING:
    ...
    from paystack.issuing._card import Card
    from paystack.issuing._cardholder import Cardholder
    from paystack.issuing._token import Token
    from paystack.issuing._transaction import Transaction
...
class Authorization(
    ...
    """
    When an [issued card](https://paystack.com/docs/issuing) is used to make a purchase, an Issuing `Authorization`
    object is created. [Authorizations](https://paystack.com/docs/issuing/purchases/authorizations) must be approved for the
    purchase to be completed successfully.

    Related guide: [Issued card authorizations](https://paystack.com/docs/issuing/purchases/authorizations)
    """
    ...
    class Fleet(paystackObject):
        class CardholderPromptData(paystackObject):
        ...
        class ReportedBreakdown(paystackObject):
            class Fuel(paystackObject):
                gross_amount_decimal: Optional[str]
                """
                Gross fuel amount that should equal Fuel Quantity multiplied by Fuel Unit Cost, inclusive of taxes.
                """

            class NonFuel(paystackObject):
                gross_amount_decimal: Optional[str]
                """
    ...
    class MerchantData(paystackObject):
        category: str
        """
        A categorization of the seller's type of business. See our [merchant categories guide](https://paystack.com/docs/issuing/merchant-categories) for a list of possible values.
        """
        category_code: str
        """
    ...
    class NetworkData(paystackObject):
    ...
    class PendingRequest(paystackObject):
        class AmountDetails(paystackObject):
            atm_fee: Optional[int]
            """
            The fee charged by the ATM for the cash withdrawal.
        ...
        amount: int
        """
        The additional amount paystack will hold if the authorization is approved, in the card's [currency](https://paystack.com/docs/api#issuing_authorization_object-pending-request-currency) and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        amount_details: Optional[AmountDetails]
        """
        Detailed breakdown of amount components. These amounts are denominated in `currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        currency: str
        """
        ...
        """
        If set `true`, you may provide [amount](https://paystack.com/docs/api/issuing/authorizations/approve#approve_issuing_authorization-amount) to control how much to hold for the authorization.
        """
        merchant_amount: int
        """
        The amount the merchant is requesting to be authorized in the `merchant_currency`. The amount is in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
    ...
    class RequestHistory(paystackObject):
        class AmountDetails(paystackObject):
            atm_fee: Optional[int]
            """
            The fee charged by the ATM for the cash withdrawal.
        ...
        amount: int
        """
        The `pending_request.amount` at the time of the request, presented in your card's currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal). paystack held this amount from your account to fund the authorization if the request was approved.
        """
        amount_details: Optional[AmountDetails]
        """
        Detailed breakdown of amount components. These amounts are denominated in `currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        ...
        """
        A code created by paystack which is shared with the merchant to validate the authorization. This field will be populated if the authorization message was approved. The code typically starts with the letter "S", followed by a six-digit number. For example, "S498162". Please note that the code is not guaranteed to be unique across authorizations.
        """
        created: int
        """
        ...
        merchant_amount: int
        """
        The `pending_request.merchant_amount` at the time of the request, presented in the `merchant_currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        merchant_currency: str
        """
        The currency that was collected by the merchant and presented to the cardholder for the authorization. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
        """
        network_risk_score: Optional[int]
        """
        The card network's estimate of the likelihood that an authorization is fraudulent. Takes on values between 1 and 99.
        ...
        """
        When an authorization is approved or declined by you or by paystack, this field provides additional detail on the reason for the outcome.
        """
    ...
    class Treasury(paystackObject):
        ...
        """
        The array of [ReceivedCredits](https://paystack.com/docs/api/treasury/received_credits) associated with this authorization
        """
        received_debits: List[str]
        """
        The array of [ReceivedDebits](https://paystack.com/docs/api/treasury/received_debits) associated with this authorization
        """
        transaction: Optional[str]
        """
        The Treasury [Transaction](https://paystack.com/docs/api/treasury/transactions) associated with this authorization
        """

    class VerificationData(paystackObject):
        class AuthenticationExemption(paystackObject):
        ...
        """
        Whether the cardholder provided a CVC and if it matched paystack's record.
        """
        expiry_check: Literal["match", "mismatch", "not_provided"]
        """
        Whether the cardholder provided an expiry date and if it matched paystack's record.
        """
        postal_code: Optional[str]
        """
    ...
    class ApproveParams(RequestOptions):
        ...
        """
        If the authorization's `pending_request.is_amount_controllable` property is `true`, you may provide this value to control how much to hold for the authorization. Must be positive (use [`decline`](https://paystack.com/docs/api/issuing/authorizations/decline) to decline an authorization request).
        """
    ...
    class CaptureParams(RequestOptions):
        ...
        """
        The amount to capture from the authorization. If not provided, the full amount of the authorization will be captured. This amount is in the authorization currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
    ...
    class CreateParams(RequestOptions):
        amount: int
        """
        The total amount to attempt to authorize. This amount is in the provided currency, or defaults to the card's currency, and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        ...
        """
        The currency of the authorization. If not provided, defaults to the currency of the card. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
        ...
        """
        Verifications that paystack performed on information that the cardholder provided to the merchant.
        """
    ...
    class FinalizeAmountParams(RequestOptions):
        ...
        final_amount: int
        """
        The final authorization amount that will be captured by the merchant. This amount is in the authorization currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
    ...
    class IncrementParams(RequestOptions):
        ...
        """
        The amount to increment the authorization by. This amount is in the authorization currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        is_amount_controllable: NotRequired[bool]
        """
        If set `true`, you may provide [amount](https://paystack.com/docs/api/issuing/authorizations/approve#approve_issuing_authorization-amount) to control how much to hold for the authorization.
    ...
    class ReverseParams(RequestOptions):
        ...
        """
        The amount to reverse from the authorization. If not provided, the full amount of the authorization will be reversed. This amount is in the authorization currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """

    amount: int
    """
    The total amount that was authorized or rejected. This amount is in `currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal). `amount` should be the same as `merchant_amount`, unless `currency` and `merchant_currency` are different.
    """
    amount_details: Optional[AmountDetails]
    """
    Detailed breakdown of amount components. These amounts are denominated in `currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
    ...
    card: "Card"
    """
    You can [create physical or virtual cards](https://paystack.com/docs/issuing/cards) that are issued to cardholders.
    """
    ...
    currency: str
    """
    The currency of the cardholder. This currency can be different from the currency presented at authorization and the `merchant_currency` field on this authorization. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
    """
    ...
    merchant_amount: int
    """
    The total amount that was authorized or rejected. This amount is in the `merchant_currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal). `merchant_amount` should be the same as `amount`, unless `merchant_currency` and `currency` are different.
    """
    merchant_currency: str
    """
    ...
    """
    History of every time a `pending_request` authorization was approved/declined, either by you directly or by paystack (e.g. based on your spending_controls). If the merchant changes the authorization by performing an incremental authorization, you can look at this field to see the previous requests for the authorization. This field can be helpful in determining why a given authorization was approved/declined.
    """
    ...
    """
    [Token](https://paystack.com/docs/api/issuing/tokens/object) object used for this authorization. If a network token was not used for this authorization, this field will be null.
    """
    transactions: List["Transaction"]
    """
    List of [transactions](https://paystack.com/docs/api/issuing/transactions) associated with this authorization.
    """
    treasury: Optional[Treasury]
    """
    [Treasury](https://paystack.com/docs/api/treasury) details related to this authorization if it was created on a [FinancialAccount](https://paystack.com/docs/api/treasury/financial_accounts).
    """
    ...
    def _cls_approve(
        ...
        **params: Unpack["Authorization.ApproveParams"],
        ...
        """
        [Deprecated] Approves a pending Issuing Authorization object. This request should be made within the timeout window of the [real-time authorization](https://paystack.com/docs/issuing/controls/real-time-authorizations) flow.
        This method is deprecated. Instead, [respond directly to the webhook request to approve an authorization](https://paystack.com/docs/issuing/controls/real-time-authorizations#authorization-handling).
        """
        return cast(
            "Authorization",
            cls._static_request(
    ...
    def _cls_decline(
        ...
        **params: Unpack["Authorization.DeclineParams"],
        ...
        """
        [Deprecated] Declines a pending Issuing Authorization object. This request should be made within the timeout window of the [real time authorization](https://paystack.com/docs/issuing/controls/real-time-authorizations) flow.
        This method is deprecated. Instead, [respond directly to the webhook request to decline an authorization](https://paystack.com/docs/issuing/controls/real-time-authorizations#authorization-handling).
        """
        return cast(
            "Authorization",
            cls._static_request(
