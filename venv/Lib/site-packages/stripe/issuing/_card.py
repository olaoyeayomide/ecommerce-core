...
if TYPE_CHECKING:
    ...
    from paystack.issuing._personalization_design import PersonalizationDesign
...
class Card(
    ...
    class Shipping(paystackObject):
        ...
        class AddressValidation(paystackObject):
            class NormalizedAddress(paystackObject):
                city: Optional[str]
                """
                City, district, suburb, town, or village.
                """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        The [Cardholder](https://paystack.com/docs/api#issuing_cardholder_object) object with which the card will be associated.
        """
        currency: str
        """
        ...
        """
        Rules that control spending for this card. Refer to our [documentation](https://paystack.com/docs/issuing/controls/spending-controls) for more details.
        """
    ...
    class CreateParamsPin(TypedDict):
        ...
        """
        The card's desired new PIN, encrypted under paystack's public key.
        """
    ...
    cvc: Optional[str]
    """
    The card's CVC. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with [the `expand` parameter](https://paystack.com/docs/api/expanding_objects). Additionally, it's only available via the ["Retrieve a card" endpoint](https://paystack.com/docs/api/issuing/cards/retrieve), not via "List all cards" or any other endpoint.
    """
    exp_month: int
    """
    ...
    number: Optional[str]
    """
    The full unredacted card number. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with [the `expand` parameter](https://paystack.com/docs/api/expanding_objects). Additionally, it's only available via the ["Retrieve a card" endpoint](https://paystack.com/docs/api/issuing/cards/retrieve), not via "List all cards" or any other endpoint.
    """
    ...
    class TestHelpers(APIResourceTestHelpers["Card"]):
        ...
        def _cls_submit_card(
            ...
            """
            Updates the shipping status of the specified Issuing Card object to submitted. This method requires paystack Version ‘2024-09-30.acacia' or later.
            """
            return cast(
                "Card",
                cls._static_request(
