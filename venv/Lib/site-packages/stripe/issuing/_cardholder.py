...
class Cardholder(
    ...
    """
    An Issuing `Cardholder` object represents an individual or business entity who is [issued](https://paystack.com/docs/issuing) cards.

    Related guide: [How to create a cardholder](https://paystack.com/docs/issuing/cards#create-cardholder)
    """

    OBJECT_NAME: ClassVar[Literal["issuing.cardholder"]] = "issuing.cardholder"

    class Billing(paystackObject):
    ...
    class Individual(paystackObject):
        class CardIssuing(paystackObject):
            class UserTermsAcceptance(paystackObject):
                date: Optional[int]
                """
            ...
            """
            Information about cardholder acceptance of Celtic [Authorized User Terms](https://paystack.com/docs/issuing/cards#accept-authorized-user-terms). Required for cards backed by a Celtic program.
            """
        ...
        class Verification(paystackObject):
            class Document(paystackObject):
                ...
                """
                The back of a document returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `identity_document`.
                """
                front: Optional[ExpandableField["File"]]
                """
                The front of a document returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `identity_document`.
                """
    ...
    class SpendingControls(paystackObject):
        class SpendingLimit(paystackObject):
            amount: int
            """
            Maximum amount allowed to spend per interval. This amount is in the card's currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
            """
            categories: Optional[
                List[
                    Literal[
            ...
            """
            Array of strings containing [categories](https://paystack.com/docs/api#issuing_authorization_object-merchant_data-category) this limit applies to. Omitting this field will apply the limit to all categories.
            """
            interval: Literal[
                "all_time",
                "daily",
        ...
        """
        Array of strings containing [categories](https://paystack.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to allow. All other categories will be blocked. Cannot be set with `blocked_categories`.
        """
        ...
        """
        Array of strings containing [categories](https://paystack.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to decline. All other categories will be allowed. Cannot be set with `allowed_categories`.
        """
    ...
    class CreateParams(RequestOptions):
        ...
        The cardholder's preferred locales (languages), ordered by preference. Locales can be `de`, `en`, `es`, `fr`, or `it`.
         This changes the language of the [3D Secure flow](https://paystack.com/docs/issuing/3d-secure) and one-time password messages sent to the cardholder.
        """
        spending_controls: NotRequired[
            "Cardholder.CreateParamsSpendingControls"
        ]
        """
        Rules that control spending across this cardholder's cards. Refer to our [documentation](https://paystack.com/docs/issuing/controls/spending-controls) for more details.
        """
        ...
        """
        One of `individual` or `company`. See [Choose a cardholder type](https://paystack.com/docs/issuing/other/choose-cardholder) for more details.
        """
    ...
    class CreateParamsIndividualVerificationDocument(TypedDict):
        ...
        """
        The back of an ID returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `identity_document`.
        """
        front: NotRequired[str]
        """
        The front of an ID returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `identity_document`.
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        phone_number: NotRequired[str]
        """
        The cardholder's phone number. This is required for all cardholders who will be creating EU cards. See the [3D Secure documentation](https://paystack.com/docs/issuing/3d-secure) for more details.
        """
        preferred_locales: NotRequired[
            List[Literal["de", "en", "es", "fr", "it"]]
        ]
    ...
    """
    The cardholder's phone number. This is required for all cardholders who will be creating EU cards. See the [3D Secure documentation](https://paystack.com/docs/issuing/3d-secure#when-is-3d-secure-applied) for more details.
    """
