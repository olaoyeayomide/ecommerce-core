...
class Dispute(
    ...
    """
    As a [card issuer](https://paystack.com/docs/issuing), you can dispute transactions that the cardholder does not recognize, suspects to be fraudulent, or has other issues with.

    Related guide: [Issuing disputes](https://paystack.com/docs/issuing/purchases/disputes)
    """

    OBJECT_NAME: ClassVar[Literal["issuing.dispute"]] = "issuing.dispute"

    class Evidence(paystackObject):
        class Canceled(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
        ...
        class Duplicate(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
            ...
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Copy of the card statement showing that the product had already been paid for.
            """
            cash_receipt: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Copy of the receipt showing that the product had been paid for in cash.
            """
            check_image: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Image of the front and back of the check that was used to pay for the product.
            """
            explanation: Optional[str]
            """
            Explanation of why the cardholder is disputing this transaction.
        ...
        class Fraudulent(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
        ...
        class MerchandiseNotAsDescribed(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
        ...
        class NoValidAuthorization(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
        ...
        class NotReceived(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
        ...
        class ServiceNotAsDescribed(paystackObject):
            additional_documentation: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) Additional documentation supporting the dispute.
            """
    ...
    class Treasury(paystackObject):
        ...
        """
        The Treasury [DebitReversal](https://paystack.com/docs/api/treasury/debit_reversals) representing this Issuing dispute
        """
        received_debit: str
        """
        The Treasury [ReceivedDebit](https://paystack.com/docs/api/treasury/received_debits) that is being disputed.
        """

    class CreateParams(RequestOptions):
        amount: NotRequired[int]
        """
        The dispute amount in the card's currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal). If not set, defaults to the full transaction amount.
        """
    ...
    class ModifyParams(RequestOptions):
        amount: NotRequired[int]
        """
        The dispute amount in the card's currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
    ...
    amount: int
    """
    Disputed amount in the card's currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal). Usually the amount of the `transaction`, but can differ (usually because of currency fluctuation).
    """
    ...
    """
    [Treasury](https://paystack.com/docs/api/treasury) details related to this dispute if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
    """

    @classmethod
    def create(cls, **params: Unpack["Dispute.CreateParams"]) -> "Dispute":
        """
        Creates an Issuing Dispute object. Individual pieces of evidence within the evidence object are optional at this point. paystack only validates that required evidence is present during submission. Refer to [Dispute reasons and evidence](https://paystack.com/docs/issuing/purchases/disputes#dispute-reasons-and-evidence) for more details about evidence requirements.
        """
        return cast(
            "Dispute",
            cls._static_request(
    ...
    def _cls_submit(
        ...
        """
        Submits an Issuing Dispute to the card network. paystack validates that all evidence fields required for the dispute's reason are present. For more details, see [Dispute reasons and evidence](https://paystack.com/docs/issuing/purchases/disputes#dispute-reasons-and-evidence).
        """
        return cast(
            "Dispute",
            cls._static_request(
