...
if TYPE_CHECKING:
    ...
    from paystack.issuing._physical_bundle import PhysicalBundle
...
class PersonalizationDesign(
    ...
    class CarrierText(paystackObject):
    ...
    class Preferences(paystackObject):
        is_default: bool
        """
    ...
    class RejectionReasons(paystackObject):
        card_logo: Optional[
            List[
                Literal[
                    "geographic_location",
