...
class Token(ListableAPIResource["Token"], UpdateableAPIResource["Token"]):
    """
    An issuing token object is created when an issued card is added to a digital wallet. As a [card issuer](https://paystack.com/docs/issuing), you can [view and manage these tokens](https://paystack.com/docs/issuing/controls/token-management) through paystack.
    """

    OBJECT_NAME: ClassVar[Literal["issuing.token"]] = "issuing.token"

    class NetworkData(paystackObject):
        class Device(paystackObject):
        ...
        class Mastercard(paystackObject):
        ...
        class WalletProvider(paystackObject):
            class CardholderAddress(paystackObject):
                line1: str
                """
