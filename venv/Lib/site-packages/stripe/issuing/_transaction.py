...
if TYPE_CHECKING:
    ...
    from paystack.issuing._authorization import Authorization
    from paystack.issuing._card import Card
    from paystack.issuing._cardholder import Cardholder
    from paystack.issuing._dispute import Dispute
...
class Transaction(
    ...
    """
    Any use of an [issued card](https://paystack.com/docs/issuing) that results in funds entering or leaving
    your paystack account, such as a completed purchase or refund, is represented by an Issuing
    `Transaction` object.

    Related guide: [Issued card transactions](https://paystack.com/docs/issuing/purchases/transactions)
    """
    ...
    class PurchaseDetails(paystackObject):
        ...
        class Flight(paystackObject):
            class Segment(paystackObject):
    ...
    class Treasury(paystackObject):
        ...
        """
        The Treasury [ReceivedCredit](https://paystack.com/docs/api/treasury/received_credits) representing this Issuing transaction if it is a refund
        """
        received_debit: Optional[str]
        """
        The Treasury [ReceivedDebit](https://paystack.com/docs/api/treasury/received_debits) representing this Issuing transaction if it is a capture
        """

    class CreateForceCaptureParams(RequestOptions):
        amount: int
        """
        The total amount to attempt to capture. This amount is in the provided currency, or defaults to the cards currency, and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        card: str
        """
        ...
        """
        The currency of the capture. If not provided, defaults to the currency of the card. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
        """
    ...
    class CreateUnlinkedRefundParams(RequestOptions):
        amount: int
        """
        The total amount to attempt to refund. This amount is in the provided currency, or defaults to the cards currency, and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
        """
        card: str
        """
        ...
        currency: NotRequired[str]
        """
        The currency of the unlinked refund. If not provided, defaults to the currency of the card. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
    ...
    amount: int
    """
    The transaction amount, which will be reflected in your balance. This amount is in your currency and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
    """
    ...
    """
    ID of the [balance transaction](https://paystack.com/docs/api/balance_transactions) associated with this transaction.
    """
    ...
    merchant_amount: int
    """
    The amount that the merchant will receive, denominated in `merchant_currency` and in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal). It will be different from `amount` if the merchant is taking payment in a different currency.
    """
    ...
    """
    [Token](https://paystack.com/docs/api/issuing/tokens/object) object used for this transaction. If a network token was not used for this transaction, this field will be null.
    """
    treasury: Optional[Treasury]
    """
    [Treasury](https://paystack.com/docs/api/treasury) details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
    """
