...
class Secret(CreateableAPIResource["Secret"], ListableAPIResource["Secret"]):
    """
    Secret Store is an API that allows paystack Apps developers to securely persist secrets for use by UI Extensions and app backends.
    ...
    Related guide: [Store data between page reloads](https://paystack.com/docs/paystack-apps/store-auth-data-custom-objects)
    """
