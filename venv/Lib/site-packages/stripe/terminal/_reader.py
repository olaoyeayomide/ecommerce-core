...
if TYPE_CHECKING:
    ...
    from paystack.terminal._location import Location
...
class Reader(
    ...
    Related guide: [Connecting to a reader](https://paystack.com/docs/terminal/payments/connect-reader)
    """

    OBJECT_NAME: ClassVar[Literal["terminal.reader"]] = "terminal.reader"

    class Action(paystackObject):
        class ProcessPaymentIntent(paystackObject):
            class ProcessConfig(paystackObject):
                class Tipping(paystackObject):
        ...
        class ProcessSetupIntent(paystackObject):
            class ProcessConfig(paystackObject):
                enable_customer_cancellation: Optional[bool]
                """
        ...
        class RefundPayment(paystackObject):
            class RefundPaymentConfig(paystackObject):
                enable_customer_cancellation: Optional[bool]
                """
        ...
        class SetReaderDisplay(paystackObject):
            class Cart(paystackObject):
                class LineItem(paystackObject):
                    amount: int
                    """
                    The amount of the line item. A positive integer in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
                    """
                    description: str
                    """
                ...
                tax: Optional[int]
                """
                Tax amount for the entire cart. A positive integer in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
                """
                total: int
                """
                Total amount for the entire cart, including tax. A positive integer in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal).
                """
    ...
    class ProcessPaymentIntentParamsProcessConfig(TypedDict):
        ...
        """
        This field indicates whether this payment method can be shown again to its customer in a checkout flow. paystack products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow.
        """
    ...
    """
    Type of reader, one of `bbpos_wisepad3`, `paystack_m2`, `paystack_s700`, `bbpos_chipper2x`, `bbpos_wisepos_e`, `verifone_P400`, `simulated_wisepos_e`, or `mobile_phone_reader`.
    """
    id: str
    """
