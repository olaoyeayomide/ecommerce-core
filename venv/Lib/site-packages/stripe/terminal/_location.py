...
class Location(
    ...
    Related guide: [Fleet management](https://paystack.com/docs/terminal/fleet/locations)
    """
    ...
    def create(cls, **params: Unpack["Location.CreateParams"]) -> "Location":
        ...
        For further details, including which address fields are required in each country, see the [Manage locations](https://paystack.com/docs/terminal/fleet/locations) guide.
        """
        return cast(
            "Location",
            cls._static_request(
