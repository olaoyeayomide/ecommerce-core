...
class PaymentMethod(
    ...
    class Card(paystackObject):
        ...
        class GeneratedFrom(paystackObject):
        ...
        class ThreeDSecureUsage(paystackObject):
            supported: bool
            """
    ...
    class UsBankAccount(paystackObject):
        ...
        class StatusDetails(paystackObject):
            class Blocked(paystackObject):
    ...
    class CreateParams(RequestOptions):
        ...
        """
        If this is a `card` PaymentMethod, this hash contains the user's card details. For backwards compatibility, you can alternatively provide a paystack token (e.g., for Apple Pay, Amex Express Checkout, or legacy Checkout) into the card hash with format `card: {token: "tok_visa"}`. When providing a card number, you must meet the requirements for [PCI compliance](https://paystack.com/docs/security#validating-pci-compliance). We strongly recommend using paystack.js instead of interacting with this API directly.
        """
    ...
    class CreateParamsCard(TypedDict):
        ...
        """
        For backwards compatibility, you can alternatively provide a paystack token (e.g., for Apple Pay, Amex Express Checkout, or legacy Checkout) into the card hash with format card: {token: "tok_visa"}.
        """
    ...
    def _cls_attach(
        ...
        **params: Unpack["PaymentMethod.AttachParams"],
        ...
        To attach a new PaymentMethod to a customer for future payments, we recommend you use a [SetupIntent](https://paystack.com/docs/api/setup_intents)
        or a PaymentIntent with [setup_future_usage](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-setup_future_usage).
        These approaches will perform any necessary steps to set up the PaymentMethod for future payments. Using the /v1/payment_methods/:id/attach
        endpoint without first using a SetupIntent or PaymentIntent with setup_future_usage does not optimize the PaymentMethod for
        future use, which makes later declines and payment friction more likely.
        See [Optimizing cards for future payments](https://paystack.com/docs/payments/payment-intents#future-usage) for more information about setting up
        future payments.

        To use this PaymentMethod as the default for invoice or subscription payments,
        set [invoice_settings.default_payment_method](https://paystack.com/docs/api/customers/update#update_customer-invoice_settings-default_payment_method),
    ...
    def create(
        ...
        """
        Creates a PaymentMethod object. Read the [paystack.js reference](https://paystack.com/docs/paystack-js/reference#paystack-create-payment-method) to learn how to create PaymentMethods via paystack.js.

        Instead of creating a PaymentMethod directly, we recommend using the [PaymentIntents API to accept a payment immediately or the <a href="/docs/payments/save-and-reuse">SetupIntent](https://paystack.com/docs/payments/accept-a-payment) API to collect payment method details ahead of a future payment.
        """
        return cast(
            "PaymentMethod",
            cls._static_request(
    ...
    def list(
        ...
        """
        Returns a list of PaymentMethods for Treasury flows. If you want to list the PaymentMethods attached to a Customer for payments, you should use the [List a Customer's PaymentMethods](https://paystack.com/docs/api/payment_methods/customer_list) API instead.
        """
    ...
    def retrieve(
        ...
        """
        Retrieves a PaymentMethod object attached to the paystackAccount. To retrieve a payment method attached to a Customer, you should use [Retrieve a Customer's PaymentMethods](https://paystack.com/docs/api/payment_methods/customer)
        """
