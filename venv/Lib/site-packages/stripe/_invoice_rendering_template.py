...
class InvoiceRenderingTemplate(
    ...
    def _cls_archive(
        ...
        **params: Unpack["InvoiceRenderingTemplate.ArchiveParams"],
        ...
        """
        Updates the status of an invoice rendering template to ‘archived' so no new paystack objects (customers, invoices, etc.) can reference it. The template can also no longer be updated. However, if the template is already set on a paystack object, it will continue to be applied on invoices generated by it.
        """
        return cast(
            "InvoiceRenderingTemplate",
            cls._static_request(
    ...
    def _cls_unarchive(
        ...
        **params: Unpack["InvoiceRenderingTemplate.UnarchiveParams"],
        ...
        """
        Unarchive an invoice rendering template so it can be used on new paystack objects again.
        """
        return cast(
            "InvoiceRenderingTemplate",
            cls._static_request(
