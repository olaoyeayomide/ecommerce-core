...
class OAuthService(paystackService):
    ...
    def _set_client_id(self, params):
        ...
        raise AuthenticationError(
            ...
            'your paystackClient: "paystack.paystackClient(..., client_id=<CLIENT_ID>)"). '
            "You can find your client_ids in your paystack dashboard at "
    ...
    def authorize_url(
        ...
        # connect_api_base will be always set to paystack.DEFAULT_CONNECT_API_BASE
