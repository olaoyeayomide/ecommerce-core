...
class AccountSession(CreateableAPIResource["AccountSession"]):
    ...
    Related guide: [Connect embedded components](https://paystack.com/docs/connect/get-started-connect-embedded-components)
    """

    OBJECT_NAME: ClassVar[Literal["account_session"]] = "account_session"

    class Components(paystackObject):
        class AccountManagement(paystackObject):
            class Features(paystackObject):
                disable_paystack_user_authentication: Optional[bool]
                """
                Disables paystack user authentication for this embedded component. This feature can only be false for accounts where you're responsible for collecting updated information when requirements are due or change, like custom accounts. The default value for this feature is `false` when `external_account_collection` is enabled and `true` otherwise.
                """
        ...
        class AccountOnboarding(paystackObject):
            class Features(paystackObject):
                disable_paystack_user_authentication: Optional[bool]
                """
                Disables paystack user authentication for this embedded component. This feature can only be false for accounts where you're responsible for collecting updated information when requirements are due or change, like custom accounts. The default value for this feature is `false` when `external_account_collection` is enabled and `true` otherwise.
        ...
        class Balances(paystackObject):
            class Features(paystackObject):
                ...
                """
                Whether to allow payout schedule to be changed. Default `true` when paystack owns Loss Liability, default `false` otherwise.
                """
                external_account_collection: bool
                """
                Whether to allow platforms to control bank account collection for their connected accounts. This feature can only be false for accounts where you're responsible for collecting updated information when requirements are due or change, like custom accounts. Otherwise, bank account collection is determined by compliance requirements. The default value for this feature is `true`.
                ...
                """
                Whether to allow creation of instant payouts. Default `true` when paystack owns Loss Liability, default `false` otherwise.
                """
                standard_payouts: bool
                """
                Whether to allow creation of standard payouts. Default `true` when paystack owns Loss Liability, default `false` otherwise.
                """
        ...
        class Documents(paystackObject):
            class Features(paystackObject):
                pass
        ...
        class NotificationBanner(paystackObject):
            class Features(paystackObject):
                disable_paystack_user_authentication: Optional[bool]
                """
                Disables paystack user authentication for this embedded component. This feature can only be false for accounts where you're responsible for collecting updated information when requirements are due or change, like custom accounts. The default value for this feature is `false` when `external_account_collection` is enabled and `true` otherwise.
        ...
        class PaymentDetails(paystackObject):
            class Features(paystackObject):
        ...
        class PayoutsList(paystackObject):
            class Features(paystackObject):
                pass
        ...
        class TaxRegistrations(paystackObject):
            class Features(paystackObject):
                pass
        ...
        class TaxSettings(paystackObject):
            class Features(paystackObject):
                pass
    ...
    class CreateParamsComponentsAccountManagementFeatures(TypedDict):
        disable_paystack_user_authentication: NotRequired[bool]
        """
        Disables paystack user authentication for this embedded component. This feature can only be false for accounts where you're responsible for collecting updated information when requirements are due or change, like custom accounts. The default value for this feature is `false` when `external_account_collection` is enabled and `true` otherwise.
        """
    ...
    Refer to our docs to [setup Connect embedded components](https://paystack.com/docs/connect/get-started-connect-embedded-components) and learn about how `client_secret` should be handled.
    """
