...
if TYPE_CHECKING:
    from paystack.billing_portal._configuration import Configuration


class Session(CreateableAPIResource["Session"]):
    """
    The Billing customer portal is a paystack-hosted UI for subscription and
    billing management.
    ...
    Related guide: [Customer management](https://paystack.com/customer-management)
    """
    ...
    class Flow(paystackObject):
        ...
        class SubscriptionCancel(paystackObject):
            class Retention(paystackObject):
                class CouponOffer(paystackObject):
                    coupon: str
                    """
        ...
        class SubscriptionUpdate(paystackObject):
            subscription: str
            """
            The ID of the subscription to be updated.
            """

        class SubscriptionUpdateConfirm(paystackObject):
            ...
            class Item(paystackObject):
                id: Optional[str]
                """
                The ID of the [subscription item](https://paystack.com/docs/api/subscriptions/object#subscription_object-items-data-id) to be updated.
                """
                price: Optional[str]
                """
                The price the customer should subscribe to through this flow. The price must also be included in the configuration's [`features.subscription_update.products`](https://paystack.com/docs/api/customer_portal/configuration#portal_configuration_object-features-subscription_update-products).
                """
                quantity: Optional[int]
                """
                [Quantity](https://paystack.com/docs/subscriptions/quantities) for this item that the customer should subscribe to through this flow.
                """
            ...
            items: List[Item]
            """
            The [subscription item](https://paystack.com/docs/api/subscription_items) to be updated through this flow. Currently, only up to one may be specified and subscriptions with multiple items are not updatable.
            """
            subscription: str
            """
            The ID of the subscription to be updated.
    ...
    class CreateParams(RequestOptions):
        ...
        """
        The ID of an existing [configuration](https://paystack.com/docs/api/customer_portal/configuration) to use for this session, describing its functionality and features. If not specified, the session uses the default configuration.
        """
        customer: str
        """
        ...
        """
        Information about a specific flow for the customer to go through. See the [docs](https://paystack.com/docs/customer-management/portal-deep-links) to learn more about using customer portal deep links and flows.
        """
        locale: NotRequired[
            Literal[
                "auto",
        ...
        """
        The `on_behalf_of` account to use for this session. When specified, only subscriptions and invoices with this `on_behalf_of` account appear in the portal. For more information, see the [docs](https://paystack.com/docs/connect/separate-charges-and-transfers#settlement-merchant). Use the [Accounts API](https://paystack.com/docs/api/accounts/object#account_object-settings-branding) to modify the `on_behalf_of` account's branding settings, which the portal displays.
        """
