...
class Plan(
    ...
    class TransformUsage(paystackObject):
        divide_by: int
        """
    ...
    class CreateParams(RequestOptions):
        ...
        id: NotRequired[str]
        """
        An identifier randomly generated by paystack. Used to identify this plan when subscribing a customer. You can optionally override this ID, but the ID must be unique across all plans in your paystack account. You can, however, use the same plan ID in both live and test modes.
        """
        ...
        """
        Default number of trial days when subscribing a customer to this plan using [`trial_from_plan=true`](https://paystack.com/docs/api#create_subscription-trial_from_plan).
        """
