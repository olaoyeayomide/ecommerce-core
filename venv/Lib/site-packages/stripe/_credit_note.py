...
if TYPE_CHECKING:
    from paystack._credit_note_line_item import CreditNoteLineItem
...
class CreditNote(
    ...
    Related guide: [Credit notes](https://paystack.com/docs/billing/invoices/credit-notes)
    """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        The integer amount in cents (or local equivalent) representing the amount that is credited outside of paystack.
        """
        reason: NotRequired[
            Literal[
                "duplicate",
    ...
    class CreateParamsLineTaxAmount(TypedDict):
        ...
        tax_rate: str
        """
        The id of the tax rate for this tax amount. The tax rate must have been automatically created by paystack.
        """
        taxable_amount: int
        """
        The amount on which tax is calculated, in cents (or local equivalent).
    ...
    """
    Amount that was credited outside of paystack.
    """
    pdf: str
    """
    ...
    """
    Status of this credit note, one of `issued` or `void`. Learn more about [voiding credit notes](https://paystack.com/docs/billing/invoices/credit-notes#voiding).
    """
    subtotal: int
    """
    ...
    def create(
        ...
        Outside of paystack credit: record the amount that is or will be credited outside of paystack (using out_of_band_amount).


        For post-payment credit notes the sum of the refund, credit and outside of paystack amounts must equal the credit note total.
    ...
    def _cls_void_credit_note(
        ...
        """
        Marks a credit note as void. Learn more about [voiding credit notes](https://paystack.com/docs/billing/invoices/credit-notes#voiding).
        """
        return cast(
            "CreditNote",
            cls._static_request(
