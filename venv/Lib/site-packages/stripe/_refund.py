...
class Refund(
    ...
    Related guide: [Refunds](https://paystack.com/docs/refunds)
    """

    OBJECT_NAME: ClassVar[Literal["refund"]] = "refund"

    class DestinationDetails(paystackObject):
        ...
        class AuBankTransfer(paystackObject):
            pass
        ...
        class BrBankTransfer(paystackObject):
            reference: Optional[str]
            """
            The reference assigned to the refund.
            """
        ...
        class CustomerCashBalance(paystackObject):
            pass
        ...
        class GbBankTransfer(paystackObject):
            reference: Optional[str]
            """
            The reference assigned to the refund.
            """
        ...
        class JpBankTransfer(paystackObject):
            reference: Optional[str]
            """
            The reference assigned to the refund.
            """
        ...
        class MxBankTransfer(paystackObject):
            reference: Optional[str]
            """
            The reference assigned to the refund.
            """
        ...
        class ThBankTransfer(paystackObject):
            reference: Optional[str]
            """
            The reference assigned to the refund.
            """
        ...
        class UsBankTransfer(paystackObject):
            reference: Optional[str]
            """
            The reference assigned to the refund.
            """
    ...
    class NextAction(paystackObject):
        class DisplayDetails(paystackObject):
            class EmailSent(paystackObject):
                email_sent_at: int
                """
    ...
    """
    Reason for the refund, which is either user-provided (`duplicate`, `fraudulent`, or `requested_by_customer`) or generated by paystack internally (`expired_uncaptured_charge`).
    """
    ...
    """
    The transfer reversal that's associated with the refund. Only present if the charge came from another paystack account.
    """
    status: Optional[str]
    """
    Status of the refund. This can be `pending`, `requires_action`, `succeeded`, `failed`, or `canceled`. Learn more about [failed refunds](https://paystack.com/docs/refunds#failed-refunds).
    """
