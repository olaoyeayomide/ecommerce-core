...
class Feature(
    ...
    Features can be assigned to products, and when those products are purchased, paystack will create an entitlement to the feature for the purchasing customer.
    """
