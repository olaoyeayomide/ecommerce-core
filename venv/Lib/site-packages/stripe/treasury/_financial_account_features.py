...
class FinancialAccountFeatures(paystackObject):
    """
    ...
    class CardIssuing(paystackObject):
        class StatusDetail(paystackObject):
            code: Literal[
                "activating",
    ...
    class DepositInsurance(paystackObject):
        class StatusDetail(paystackObject):
            code: Literal[
                "activating",
                "capability_not_requested",
    ...
    class FinancialAddresses(paystackObject):
    ...
    class InboundTransfers(paystackObject):
    ...
    class IntrapaystackFlows(paystackObject):
        class StatusDetail(paystackObject):
            code: Literal[
                "activating",
                "capability_not_requested",
    ...
    class OutboundPayments(paystackObject):
        class Ach(paystackObject):
            class StatusDetail(paystackObject):
                code: Literal[
                    "activating",
    ...
    class OutboundTransfers(paystackObject):
        class Ach(paystackObject):
            class StatusDetail(paystackObject):
                code: Literal[
                    "activating",
    ...
    """
    intra_paystack_flows: Optional[IntrapaystackFlows]
    """
    Toggle settings for enabling/disabling a feature
    """
    ...
    _inner_class_types = {
        ...
        "intra_paystack_flows": IntrapaystackFlows,
