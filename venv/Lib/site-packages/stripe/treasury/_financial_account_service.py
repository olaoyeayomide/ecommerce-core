...
from paystack.treasury._financial_account import FinancialAccount
from paystack.treasury._financial_account_features_service import (
...
class FinancialAccountService(paystackService):
    ...
    class CreateParamsFeatures(TypedDict):
        ...
        intra_paystack_flows: NotRequired[
            "FinancialAccountService.CreateParamsFeaturesIntrapaystackFlows"
        ]
        """
    ...
    class UpdateParamsFeatures(TypedDict):
        ...
        """
        intra_paystack_flows: NotRequired[
            "FinancialAccountService.UpdateParamsFeaturesIntrapaystackFlows"
        ]
        """
        Represents the ability for the FinancialAccount to send money to, or receive money from other FinancialAccounts (for example, via OutboundPayment).
        """
    ...
    class UpdateParamsFeaturesIntrapaystackFlows(TypedDict):
        requested: bool
        """
        Whether the FinancialAccount should have the Feature.
        """
