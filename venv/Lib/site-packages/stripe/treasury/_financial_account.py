...
if TYPE_CHECKING:
    from paystack.treasury._financial_account_features import (
...
class FinancialAccount(
    ...
    """
    paystack Treasury provides users with a container for money called a FinancialAccount that is separate from their Payments balance.
    ...
    class PlatformRestrictions(paystackObject):
    ...
    class CreateParams(RequestOptions):
        ...
        """
        Encodes whether a FinancialAccount has access to a particular feature. paystack or the platform can control features via the requested field.
        """
    ...
    class CreateParamsFeatures(TypedDict):
        ...
        """
        intra_paystack_flows: NotRequired[
            "FinancialAccount.CreateParamsFeaturesIntrapaystackFlows"
        ]
        """
    ...
    class CreateParamsFeaturesIntrapaystackFlows(TypedDict):
        requested: bool
        """
        Whether the FinancialAccount should have the Feature.
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        """
        Encodes whether a FinancialAccount has access to a particular feature, with a status enum and associated `status_details`. paystack or the platform may control features via the requested field.
        """
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
    ...
    class ModifyParamsFeatures(TypedDict):
        ...
        """
        intra_paystack_flows: NotRequired[
            "FinancialAccount.ModifyParamsFeaturesIntrapaystackFlows"
        ]
        """
        Represents the ability for the FinancialAccount to send money to, or receive money from other FinancialAccounts (for example, via OutboundPayment).
        """
    ...
    class ModifyParamsFeaturesIntrapaystackFlows(TypedDict):
        requested: bool
        """
        Whether the FinancialAccount should have the Feature.
        """
    ...
    class UpdateFeaturesParams(RequestOptions):
        ...
        """
        intra_paystack_flows: NotRequired[
            "FinancialAccount.UpdateFeaturesParamsIntrapaystackFlows"
        ]
        """
        Represents the ability for the FinancialAccount to send money to, or receive money from other FinancialAccounts (for example, via OutboundPayment).
        """
    ...
    class UpdateFeaturesParamsIntrapaystackFlows(TypedDict):
        requested: bool
        """
        Whether the FinancialAccount should have the Feature.
        """
    ...
    paystack or the platform can control Features via the requested field.
    """
