...
class OutboundPayment(
    ...
    class DestinationPaymentMethodDetails(paystackObject):
        ...
        class UsBankAccount(paystackObject):
            ...
            """
            The network rails used. See the [docs](https://paystack.com/docs/treasury/money-movement/timelines) to learn more about money movement timelines for each network type.
            """
    ...
    class EndUserDetails(paystackObject):
    ...
    class ReturnedDetails(paystackObject):
        code: Literal[
            "account_closed",
            "account_frozen",
    ...
    class TrackingDetails(paystackObject):
        class Ach(paystackObject):
            trace_id: str
            """
            ACH trace ID of the OutboundPayment for payments sent over the `ach` network.
            """

        class UsDomesticWire(paystackObject):
            chips: Optional[str]
            """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        The description that appears on the receiving end for this OutboundPayment (for example, bank statement for external bank transfer). Maximum 10 characters for `ach` payments, 140 characters for `us_domestic_wire` payments, or 500 characters for `paystack` network transfers. The default value is "payment".
        """
    ...
    """
    ID of the [customer](https://paystack.com/docs/api/customers) to whom an OutboundPayment is sent.
    """
