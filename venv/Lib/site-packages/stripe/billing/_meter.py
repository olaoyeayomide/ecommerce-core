...
if TYPE_CHECKING:
    from paystack.billing._meter_event_summary import MeterEventSummary
...
class Meter(
    ...
    Related guide: [Usage based billing](https://docs.paystack.com/billing/subscriptions/usage-based)
    """

    OBJECT_NAME: ClassVar[Literal["billing.meter"]] = "billing.meter"

    class CustomerMapping(paystackObject):
    ...
    class DefaultAggregation(paystackObject):
    ...
    class ValueSettings(paystackObject):
        event_payload_key: str
        """
