...
class CreditGrant(
    ...
    Related guide: [Billing credits](https://docs.paystack.com/billing/subscriptions/usage-based/billing-credits)
    end
    """
    ...
    class Amount(paystackObject):
        class Monetary(paystackObject):
            currency: str
            """
    ...
    class ApplicabilityConfig(paystackObject):
        class Scope(paystackObject):
            price_type: Literal["metered"]
            """
            The price type to which credit grants can apply to. We currently only support `metered` price type. This refers to prices that have a [Billing Meter](https://docs.paystack.com/api/billing/meter) attached to them.
            """
    ...
    class CreateParamsAmountMonetary(TypedDict):
        currency: str
        """
        Three-letter [ISO code for the currency](https://paystack.com/docs/currencies) of the `value` parameter.
        """
        value: int
        """
