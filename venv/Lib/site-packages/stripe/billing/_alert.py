...
if TYPE_CHECKING:
    ...
    from paystack.billing._meter import Meter
...
class Alert(CreateableAPIResource["Alert"], ListableAPIResource["Alert"]):
    ...
    class UsageThreshold(paystackObject):
        class Filter(paystackObject):
        ...
        """
        The [Billing Meter](https://paystack.com/api/billing/meter) ID whose usage is monitored.
        """
    ...
    """
    Encapsulates configuration of the alert to monitor usage on a specific [Billing Meter](https://paystack.com/docs/api/billing/meter).
    """
