...
import paystack  # noqa
from paystack._error_object import ErrorObject
...
class paystackError(Exception):
        ...
        if http_body and hasattr(http_body, "decode"):
            try:
                ...
                body = (
                    ...
                    "Please report to support@paystack.com>"
                )
    ...
    # the raw message returned by paystack's API. This was previously available
    ...
    def _construct_error_object(self) -> Optional[ErrorObject]:
        ...
        return ErrorObject._construct_from(
            ...
            requestor=paystack._APIRequestor._global_instance(),
...
class paystackErrorWithParamCode(paystackError):
    def __repr__(self):
        return (
...
class CardError(paystackErrorWithParamCode):
    def __init__(
        self,
        message,
        param,
...
class IdempotencyError(paystackError):
    pass


class InvalidRequestError(paystackErrorWithParamCode):
    def __init__(
        self,
        message,
        param,
...
class PermissionError(paystackError):
    pass
...
class SignatureVerificationError(paystackError):
...
class TemporarySessionExpiredError(paystackError):
    pass
