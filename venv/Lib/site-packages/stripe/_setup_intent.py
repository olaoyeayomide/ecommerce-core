...
if TYPE_CHECKING:
    ...
    from paystack._setup_attempt import SetupAttempt
...
class SetupIntent(
    ...
    class LastSetupError(paystackObject):
        charge: Optional[str]
        """
    ...
    class NextAction(paystackObject):
        ...
        """
        When confirming a SetupIntent with paystack.js, paystack.js depends on the contents of this dictionary to invoke authentication flows. The shape of the contents is subject to change and is only intended to be used by paystack.js.
        """
    ...
    class PaymentMethodOptions(paystackObject):
        class AcssDebit(paystackObject):
            class MandateOptions(paystackObject):
                ...
                """
                List of paystack products where this mandate can be selected automatically.
                """
    ...
    class ConfirmParams(RequestOptions):
        ...
        """
        When included, this hash creates a PaymentMethod that is set as the [`payment_method`](https://paystack.com/docs/api/setup_intents/object#setup_intent_object-payment_method)
    ...
    class ConfirmParamsPaymentMethodOptionsCardMandateOptions(TypedDict):
        ...
        currency: str
        """
        Currency in which future payments will be charged. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
        """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        If present, the SetupIntent's payment method will be attached to the in-context paystack Account.

        It can only be used for this paystack Account's own money movement flows like InboundTransfer and OutboundTransfers. It cannot be set to true when setting up a PaymentMethod for a Customer, and defaults to false when attaching a PaymentMethod to a Customer.
        """
        ...
        """
        This hash contains details about the mandate to create. This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/setup_intents/create#create_setup_intent-confirm).
        """
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
        ...
        """
        The paystack account ID created for this SetupIntent.
        """
        payment_method: NotRequired[str]
        """
        ID of the payment method (a PaymentMethod, Card, or saved Source object) to attach to this SetupIntent.
        ...
        return_url: NotRequired[str]
        """
        The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method's app or site. To redirect to a mobile application, you can alternatively supply an application URI scheme. This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/setup_intents/create#create_setup_intent-confirm).
        """
    ...
    """
    ID of the payment method used with this SetupIntent. If the payment method is `card_present` and isn't a digital wallet, then the [generated_card](https://docs.paystack.com/api/setup_attempts/object#setup_attempt_object-payment_method_details-card_present-generated_card) associated with the `latest_attempt` is attached to the Customer instead.
    """
    ...
    """
    [Status](https://paystack.com/docs/payments/intents#intent-statuses) of this SetupIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `canceled`, or `succeeded`.
    """
    usage: str
    """
    ...
    def _cls_cancel(
        ...
        After you cancel it, setup is abandoned and any operations on the SetupIntent fail with an error. You can't cancel the SetupIntent for a Checkout Session. [Expire the Checkout Session](https://paystack.com/docs/api/checkout/sessions/expire) instead.
        """
        return cast(
            "SetupIntent",
            cls._static_request(
    ...
    def create(
        ...
        After you create the SetupIntent, attach a payment method and [confirm](https://paystack.com/docs/api/setup_intents/confirm)
    ...
    def retrieve(
        ...
        When retrieved with a publishable key, only a subset of properties will be returned. Please refer to the [SetupIntent](https://paystack.com/docs/api#setup_intent_object) object reference for more details.
        """
