...
class paystackResponseBase(object):
    code: int
...
class paystackResponse(paystackResponseBase):
    body: str
    data: object

    def __init__(self, body: str, code: int, headers: Mapping[str, str]):
        paystackResponseBase.__init__(self, code, headers)
        self.body = body
        self.data = json.loads(body, object_pairs_hook=OrderedDict)


class paystackStreamResponse(paystackResponseBase):
    io: IOBase
...
class paystackStreamResponseAsync(paystackResponseBase):
