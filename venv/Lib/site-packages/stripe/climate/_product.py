...
class Product(ListableAPIResource["Product"]):
    ...
    class CurrentPricesPerMetricTon(paystackObject):
        amount_fees: int
        """
    ...
    that start with `climsku_`. See [carbon removal inventory](https://paystack.com/docs/climate/orders/carbon-removal-inventory)
