...
if TYPE_CHECKING:
    from paystack.climate._product import Product
    from paystack.climate._supplier import Supplier
...
class Order(
    ...
    class Beneficiary(paystackObject):
        public_name: str
        """
        Publicly displayable name for the end beneficiary of carbon removal.
        """

    class DeliveryDetail(paystackObject):
    ...
    class CreateParams(RequestOptions):
        ...
        """
        Publicly sharable reference for the end beneficiary of carbon removal. Assumed to be the paystack account if not set.
        """
        currency: NotRequired[str]
        """
        Request currency for the order as a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a supported [settlement currency for your account](https://paystack.com/docs/currencies). If omitted, the account's default currency will be used.
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
    ...
    def _cls_cancel(
        ...
        """
        Cancels a Climate order. You can cancel an order within 24 hours of creation. paystack refunds the
        reservation amount_subtotal, but not the amount_fees for user-triggered cancellations. Frontier
        might cancel reservations if suppliers fail to deliver. If Frontier cancels the reservation, paystack
    ...
    def create(cls, **params: Unpack["Order.CreateParams"]) -> "Order":
        ...
        after creation and payment will be deducted your paystack balance.
        """
        return cast(
            "Order",
            cls._static_request(
