...
class SourceTransaction(paystackObject):
    """
    ...
    class ChfCreditTransfer(paystackObject):
    ...
    class GbpCreditTransfer(paystackObject):
        fingerprint: Optional[str]
        """
        Bank account fingerprint associated with the paystack owned bank account receiving the transfer.
        """
    ...
    class PaperCheck(paystackObject):
