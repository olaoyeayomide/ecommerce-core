...
from paystack._search_result_object import SearchResultObject
from paystack._searchable_api_resource import SearchableAPIResource
...
if TYPE_CHECKING:
    from paystack._account import Account
    from paystack._application import Application
    from paystack._bank_account import BankAccount
    from paystack._card import Card as CardResource
    from paystack._charge import Charge
    from paystack._customer import Customer
    from paystack._invoice import Invoice
    from paystack._payment_method import PaymentMethod
    from paystack._review import Review
    from paystack._setup_intent import SetupIntent
    from paystack._source import Source
...
class PaymentIntent(
    ...
    [multiple statuses](https://paystack.com/docs/payments/intents#intent-statuses)
    throughout its lifetime as it interfaces with paystack.js to perform
    authentication flows and ultimately creates at most one successful charge.

    Related guide: [Payment Intents API](https://paystack.com/docs/payments/payment-intents)
    """

    OBJECT_NAME: ClassVar[Literal["payment_intent"]] = "payment_intent"

    class AmountDetails(paystackObject):
        class Tip(paystackObject):
            amount: Optional[int]
            """
    ...
    class AutomaticPaymentMethods(paystackObject):
        allow_redirects: Optional[Literal["always", "never"]]
        """
        Controls whether this PaymentIntent will accept redirect-based payment methods.

        Redirect-based payment methods may require your customer to be redirected to a payment method's app or site for authentication or additional steps. To [confirm](https://paystack.com/docs/api/payment_intents/confirm) this PaymentIntent, you may be required to provide a `return_url` to redirect customers back to your site after they authenticate or complete the payment.
        """
        enabled: bool
        """
    ...
    class LastPaymentError(paystackObject):
        charge: Optional[str]
        """
        ...
        """
        For some errors that could be handled programmatically, a short string indicating the [error code](https://paystack.com/docs/error-codes) reported.
        """
        decline_code: Optional[str]
        """
        For card errors resulting from a card issuer decline, a short string indicating the [card issuer's reason for the decline](https://paystack.com/docs/declines#issuer-declines) if they provide one.
        """
        doc_url: Optional[str]
        """
        A URL to more information about the [error code](https://paystack.com/docs/error-codes) reported.
        """
        ...
        You can use them with [PaymentIntents](https://paystack.com/docs/payments/payment-intents) to collect payments or save them to
        Customer objects to store instrument details for future payments.

        Related guides: [Payment Methods](https://paystack.com/docs/payments/payment-methods) and [More Payment Scenarios](https://paystack.com/docs/payments/more-payment-scenarios).
        """
        ...
        Later, you can use [PaymentIntents](https://paystack.com/docs/api#payment_intents) to drive the payment flow.

        Create a SetupIntent when you're ready to collect your customer's payment credentials.
        Don't maintain long-lived, unconfirmed SetupIntents because they might not be valid.
        The SetupIntent transitions through multiple [statuses](https://docs.paystack.com/payments/intents#intent-statuses) as it guides
        you through the setup process.

        Successful SetupIntents result in payment credentials that are optimized for future payments.
        For example, cardholders in [certain regions](https://paystack.com/guides/strong-customer-authentication) might need to be run through
        [Strong Customer Authentication](https://docs.paystack.com/strong-customer-authentication) during payment method collection
        to streamline later [off-session payments](https://docs.paystack.com/payments/setup-intents).
        If you use the SetupIntent with a [Customer](https://paystack.com/docs/api#setup_intent_object-customer),
        it automatically attaches the resulting payment method to that Customer after successful setup.
        We recommend using SetupIntents or [setup_future_usage](https://paystack.com/docs/api#payment_intent_object-setup_future_usage) on
        PaymentIntents to save payment methods to prevent saving invalid or unoptimized payment methods.

        By using SetupIntents, you can reduce friction for your customers, even as regulations change over time.

        Related guide: [Setup Intents API](https://docs.paystack.com/payments/setup-intents)
        """
        source: Optional[
    ...
    class NextAction(paystackObject):
        class AlipayHandleRedirect(paystackObject):
        ...
        class BoletoDisplayDetails(paystackObject):
        ...
        class CardAwaitNotification(paystackObject):
        ...
        class CashappHandleRedirectOrDisplayQrCode(paystackObject):
            class QrCode(paystackObject):
                expires_at: int
                """
        ...
        class DisplayBankTransferInstructions(paystackObject):
            class FinancialAddress(paystackObject):
                class Aba(paystackObject):
                    account_number: str
                    """
        ...
        class KonbiniDisplayDetails(paystackObject):
            class Stores(paystackObject):
                class Familymart(paystackObject):
                ...
                class Seicomart(paystackObject):
                    confirmation_number: Optional[str]
                    """
                    The confirmation number.
                    """
        ...
        class MultibancoDisplayDetails(paystackObject):
            entity: Optional[str]
            """
        ...
        class OxxoDisplayDetails(paystackObject):
        ...
        class PaynowDisplayQrCode(paystackObject):
            data: str
            """
        ...
        class PixDisplayQrCode(paystackObject):
            data: Optional[str]
            """
            The raw data string used to generate QR code, it should be used together with QR code library.
            """
        ...
        class PromptpayDisplayQrCode(paystackObject):
            data: str
            """
            The raw data string used to generate QR code, it should be used together with QR code library.
            """
        ...
        class RedirectToUrl(paystackObject):
            return_url: Optional[str]
            """
            If the customer does not exit their browser while authenticating, they will be redirected to this specified URL after completion.
            """
        ...
        class SwishHandleRedirectOrDisplayQrCode(paystackObject):
            class QrCode(paystackObject):
                data: str
                """
                The raw data string used to generate QR code, it should be used together with QR code library.
        ...
        class VerifyWithMicrodeposits(paystackObject):
            arrival_date: int
            """
        ...
        class WechatPayDisplayQrCode(paystackObject):
            data: str
            """
        ...
        class WechatPayRedirectToAndroidApp(paystackObject):
            app_id: str
            """
        ...
        class WechatPayRedirectToIosApp(paystackObject):
            native_url: str
            """
        ...
        type: str
        """
        Type of the next action to perform, one of `redirect_to_url`, `use_paystack_sdk`, `alipay_handle_redirect`, `oxxo_display_details`, or `verify_with_microdeposits`.
        """
        use_paystack_sdk: Optional[Dict[str, Any]]
        """
        When confirming a PaymentIntent with paystack.js, paystack.js depends on the contents of this dictionary to invoke authentication flows. The shape of the contents is subject to change and is only intended to be used by paystack.js.
        """
    ...
    class PaymentMethodConfigurationDetails(paystackObject):
        id: str
        """
    ...
    class PaymentMethodOptions(paystackObject):
        class AcssDebit(paystackObject):
            class MandateOptions(paystackObject):
            ...
            If you provide a Customer with the PaymentIntent, you can use this parameter to [attach the payment method](https://paystack.com/payments/save-during-payment) to the Customer after the PaymentIntent is confirmed and the customer completes any required actions. If you don't provide a Customer, you can still [attach](https://paystack.com/api/payment_methods/attach) the payment method to a Customer after the transaction completes.

            If the payment method is `card_present` and isn't a digital wallet, paystack creates and attaches a [generated_card](https://paystack.com/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.

            When processing card payments, paystack uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](https://paystack.com/strong-customer-authentication).
            """
        ...
        class AfterpayClearpay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class Alma(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """

        class AmazonPay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class AuBecsDebit(paystackObject):
            setup_future_usage: Optional[
                Literal["none", "off_session", "on_session"]
            ]
            """
        ...
        class BacsDebit(paystackObject):
            class MandateOptions(paystackObject):
                pass
        ...
        class Bancontact(paystackObject):
        ...
        class Card(paystackObject):
            class Installments(paystackObject):
                class AvailablePlan(paystackObject):
                    count: Optional[int]
                    """
            ...
            For more information, see the [installments integration guide](https://paystack.com/docs/payments/installments).
            """
            mandate_options: Optional[MandateOptions]
            """
            ...
            """
            Request ability to [capture beyond the standard authorization validity window](https://paystack.com/docs/payments/extended-authorization) for this PaymentIntent.
            """
            request_incremental_authorization: Optional[
                Literal["if_available", "never"]
            ]
            """
            Request ability to [increment the authorization](https://paystack.com/docs/payments/incremental-authorization) for this PaymentIntent.
            """
            request_multicapture: Optional[Literal["if_available", "never"]]
            """
            Request ability to make [multiple captures](https://paystack.com/docs/payments/multicapture) for this PaymentIntent.
            """
            request_overcapture: Optional[Literal["if_available", "never"]]
            """
            Request ability to [overcapture](https://paystack.com/docs/payments/overcapture) for this PaymentIntent.
            """
            request_three_d_secure: Optional[
                Literal["any", "automatic", "challenge"]
            ]
            """
            We strongly recommend that you rely on our SCA Engine to automatically prompt your customers for authentication based on risk level and [other requirements](https://paystack.com/docs/strong-customer-authentication). However, if you wish to request 3D Secure based on logic from your own fraud engine, provide this option. If not provided, this value defaults to `automatic`. Read our guide on [manually requesting 3D Secure](https://paystack.com/docs/payments/3d-secure/authentication-flow#manual-three-ds) for more information on how this configuration interacts with Radar and our SCA Engine.
            """
        ...
        class CardPresent(paystackObject):
            class Routing(paystackObject):
            ...
            """
            Request ability to capture this payment beyond the standard [authorization validity window](https://paystack.com/docs/terminal/features/extended-authorizations#authorization-validity)
            """
            request_incremental_authorization_support: Optional[bool]
            """
            Request ability to [increment](https://paystack.com/docs/terminal/features/incremental-authorizations) this PaymentIntent if the combination of MCC and card brand is eligible. Check [incremental_authorization_supported](https://paystack.com/docs/api/charges/object#charge_object-payment_method_details-card_present-incremental_authorization_supported) in the [Confirm](https://paystack.com/docs/api/payment_intents/confirm) response to verify support.
            """
            routing: Optional[Routing]
            _inner_class_types = {"routing": Routing}

        class Cashapp(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class CustomerBalance(paystackObject):
            class BankTransfer(paystackObject):
                class EuBankTransfer(paystackObject):
        ...
        class InteracPresent(paystackObject):
            pass

        class KakaoPay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class Mobilepay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class Multibanco(paystackObject):
            setup_future_usage: Optional[Literal["none"]]
            """
            Indicates that you intend to make future payments with this PaymentIntent's payment method.
        ...
        class NaverPay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """

        class Oxxo(paystackObject):
            expires_after_days: int
            """
        ...
        class Payco(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """

        class Paynow(paystackObject):
            setup_future_usage: Optional[Literal["none"]]
            """
            Indicates that you intend to make future payments with this PaymentIntent's payment method.
        ...
        class Promptpay(paystackObject):
            setup_future_usage: Optional[Literal["none"]]
            """
            Indicates that you intend to make future payments with this PaymentIntent's payment method.
        ...
        class RevolutPay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class SamsungPay(paystackObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """

        class SepaDebit(paystackObject):
            class MandateOptions(paystackObject):
                pass
        ...
        class UsBankAccount(paystackObject):
            class FinancialConnections(paystackObject):
                class Filters(paystackObject):
        ...
        class WechatPay(paystackObject):
            app_id: Optional[str]
            """
    ...
    class Processing(paystackObject):
        class Card(paystackObject):
            class CustomerNotification(paystackObject):
    ...
    class TransferData(paystackObject):
        amount: Optional[int]
        """
        Amount intended to be collected by this PaymentIntent. A positive integer representing how much to charge in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal) (e.g., 100 cents to charge $1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is $0.50 US or [equivalent in charge currency](https://paystack.com/docs/currencies#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of $999,999.99).
        """
    ...
    class ApplyCustomerBalanceParams(RequestOptions):
        ...
        A positive integer representing how much to charge in the [smallest currency unit](https://paystack.com/docs/currencies#zero-decimal) (for example, 100 cents to charge 1 USD or 100 to charge 100 JPY, a zero-decimal currency). The maximum amount is the amount of the PaymentIntent.
    ...
    class CaptureParams(RequestOptions):
        ...
        """
        The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's paystack account. The amount of the application fee collected will be capped at the total payment amount. For more information, see the PaymentIntents [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
        ...
        """
        Defaults to `true`. When capturing a PaymentIntent, setting `final_capture` to `false` notifies paystack to not release the remaining uncaptured funds to make sure that they're captured in future requests. You can only use this setting when [multicapture](https://paystack.com/docs/payments/multicapture) is available for PaymentIntents.
        """
        ...
        Setting this value for a card charge returns an error. For card charges, set the [statement_descriptor_suffix](https://docs.paystack.com/get-started/account/statement-descriptors#dynamic) instead.
        """
        statement_descriptor_suffix: NotRequired[str]
        """
        Provides information about a card charge. Concatenated to the account's [statement descriptor prefix](https://docs.paystack.com/get-started/account/statement-descriptors#static) to form the complete statement descriptor that appears on the customer's statement.
        """
        transfer_data: NotRequired["PaymentIntent.CaptureParamsTransferData"]
        """
        The parameters that you can use to automatically create a transfer after the payment
        is captured. Learn more about the [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
        """
    ...
    class ConfirmParams(RequestOptions):
        ...
        """
        Set to `true` to fail the payment attempt if the PaymentIntent transitions into `requires_action`. This parameter is intended for simpler integrations that do not handle customer actions, like [saving cards without authentication](https://paystack.com/docs/payments/save-card-without-authentication).
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
        ...
        """
        Set to `true` to indicate that the customer isn't in your checkout flow during this payment attempt and can't authenticate. Use this parameter in scenarios where you collect card details and [charge them later](https://paystack.com/docs/payments/cards/charging-saved-cards).
        """
        payment_method: NotRequired[str]
        """
        ID of the payment method (a PaymentMethod, Card, or [compatible Source](https://paystack.com/docs/payments/payment-methods/transitioning#compatibility) object) to attach to this PaymentIntent.
        """
        ...
        in the [payment_method](https://paystack.com/docs/api/payment_intents/object#payment_intent_object-payment_method)
        ...
        """
        The list of payment method types (for example, a card) that this PaymentIntent can use. Use `automatic_payment_methods` to manage payment methods from the [paystack Dashboard](https://dashboard.paystack.com/settings/payment_methods).
        """
        radar_options: NotRequired["PaymentIntent.ConfirmParamsRadarOptions"]
        """
        Options to configure Radar. Learn more about [Radar Sessions](https://paystack.com/docs/radar/radar-session).
        """
        receipt_email: NotRequired["Literal['']|str"]
        """
        Email address that the receipt for the resulting payment will be sent to. If `receipt_email` is specified for a payment in live mode, a receipt will be sent regardless of your [email settings](https://dashboard.paystack.com/account/emails).
        """
        ...
        """
        use_paystack_sdk: NotRequired[bool]
        """
        Set to `true` when confirming server-side and using paystack.js, iOS, or Android client-side SDKs to handle the next actions.
        """
    ...
    class ConfirmParamsPaymentMethodData(TypedDict):
        ...
        """
        This field indicates whether this payment method can be shown again to its customer in a checkout flow. paystack products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to `unspecified`.
        """
        ...
        """
        Options to configure Radar. See [Radar Session](https://paystack.com/docs/radar/radar-session) for more information.
        """
    ...
    class ConfirmParamsPaymentMethodDataRadarOptions(TypedDict):
        ...
        """
        A [Radar Session](https://paystack.com/docs/radar/radar-session) is a snapshot of the browser metadata and device details that help Radar make more accurate predictions on your payments.
        """
    ...
    class ConfirmParamsPaymentMethodOptionsAffirm(TypedDict):
        ...
        If provided, this parameter overrides the behavior of the top-level [capture_method](https://paystack.com/api/payment_intents/update#update_payment_intent-capture_method) for this payment method type when finalizing the payment with this payment method type.
    ...
    class ConfirmParamsPaymentMethodOptionsPaypal(TypedDict):
        ...
        """
        [Preferred locale](https://paystack.com/docs/payments/paypal/supported-locales) of the PayPal checkout page that the customer is redirected to.
        """
        reference: NotRequired[str]
        """
        A reference of the PayPal transaction visible to customer which is mapped to PayPal's invoice ID. This must be a globally unique ID if you have configured in your PayPal settings to block multiple payments per invoice ID.
    ...
    class CreateParams(RequestOptions):
        ...
        """
        Set to `true` to attempt to [confirm this PaymentIntent](https://paystack.com/docs/api/payment_intents/confirm) immediately. This parameter defaults to `false`. When creating and confirming a PaymentIntent at the same time, you can also provide the parameters available in the [Confirm API](https://paystack.com/docs/api/payment_intents/confirm).
        """
        ...
        error_on_requires_action: NotRequired[bool]
        """
        Set to `true` to fail the payment attempt if the PaymentIntent transitions into `requires_action`. Use this parameter for simpler integrations that don't handle customer actions, such as [saving cards without authentication](https://paystack.com/docs/payments/save-card-without-authentication). This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-confirm).
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
        ...
        mandate: NotRequired[str]
        """
        ID of the mandate that's used for this payment. This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-confirm).
        """
        mandate_data: NotRequired[
            "Literal['']|PaymentIntent.CreateParamsMandateData"
        ]
        """
        This hash contains details about the Mandate to create. This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-confirm).
        """
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
        ...
        off_session: NotRequired["bool|Literal['one_off', 'recurring']"]
        """
        Set to `true` to indicate that the customer isn't in your checkout flow during this payment attempt and can't authenticate. Use this parameter in scenarios where you collect card details and [charge them later](https://paystack.com/docs/payments/cards/charging-saved-cards). This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-confirm).
        """
        on_behalf_of: NotRequired[str]
        """
        The paystack account ID that these funds are intended for. Learn more about the [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
        """
        payment_method: NotRequired[str]
        """
        ID of the payment method (a PaymentMethod, Card, or [compatible Source](https://paystack.com/docs/payments/payment-methods#compatibility) object) to attach to this PaymentIntent.
        ...
        payment_method_types: NotRequired[List[str]]
        """
        The list of payment method types (for example, a card) that this PaymentIntent can use. If you don't provide this, it defaults to ["card"]. Use `automatic_payment_methods` to manage payment methods from the [paystack Dashboard](https://dashboard.paystack.com/settings/payment_methods).
        """
        ...
        """
        Email address to send the receipt to. If you specify `receipt_email` for a payment in live mode, you send a receipt regardless of your [email settings](https://dashboard.paystack.com/account/emails).
        """
        return_url: NotRequired[str]
        """
        The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method's app or site. If you'd prefer to redirect to a mobile application, you can alternatively supply an application URI scheme. This parameter can only be used with [`confirm=true`](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-confirm).
        """
        ...
        Learn more about the [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
        """
        transfer_group: NotRequired[str]
        """
        A string that identifies the resulting payment as part of a group. Learn more about the [use case for connected accounts](https://paystack.com/docs/connect/separate-charges-and-transfers).
        """
        use_paystack_sdk: NotRequired[bool]
        """
        Set to `true` when confirming server-side and using paystack.js, iOS, or Android client-side SDKs to handle the next actions.
    ...
    class CreateParamsTransferData(TypedDict):
        ...
        [application_fee_amount](https://paystack.com/docs/api/payment_intents/create#create_payment_intent-application_fee_amount)
    ...
    class ModifyParams(RequestOptions):
        ...
        payment_method: NotRequired[str]
        """
        ID of the payment method (a PaymentMethod, Card, or [compatible Source](https://paystack.com/docs/payments/payment-methods/transitioning#compatibility) object) to attach to this PaymentIntent. To unset this field to null, pass in an empty string.
        """
        payment_method_configuration: NotRequired[str]
        """
        The ID of the payment method configuration to use with this PaymentIntent.
        ...
        payment_method_types: NotRequired[List[str]]
        """
        The list of payment method types (for example, card) that this PaymentIntent can use. Use `automatic_payment_methods` to manage payment methods from the [paystack Dashboard](https://dashboard.paystack.com/settings/payment_methods).
        """
        receipt_email: NotRequired["Literal['']|str"]
        """
        Email address that the receipt for the resulting payment will be sent to. If `receipt_email` is specified for a payment in live mode, a receipt will be sent regardless of your [email settings](https://dashboard.paystack.com/account/emails).
        ...
        """
        Use this parameter to automatically create a Transfer when the payment succeeds. Learn more about the [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
        """
        transfer_group: NotRequired[str]
        """
        A string that identifies the resulting payment as part of a group. You can only provide `transfer_group` if it hasn't been set. Learn more about the [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
        """
    ...
    class SearchParams(RequestOptions):
        ...
        query: str
        """
        The search query string. See [search query language](https://paystack.com/docs/search#search-query-language) and the list of supported [query fields for payment intents](https://paystack.com/docs/search#query-fields-for-payment-intents).
        """
    ...
    """
    Settings to configure compatible payment methods from the [paystack Dashboard](https://dashboard.paystack.com/settings/payment_methods)
    """
    ...
    """
    Reason for cancellation of this PaymentIntent, either user-provided (`duplicate`, `fraudulent`, `requested_by_customer`, or `abandoned`) or generated by paystack internally (`failed_invoice`, `void_invoice`, or `automatic`).
    """
    ...
    Refer to our docs to [accept a payment](https://paystack.com/docs/payments/accept-a-payment?ui=elements) and learn about how `client_secret` should be handled.
    """
    ...
    """
    ID of the latest [Charge object](https://paystack.com/docs/api/charges) created by this PaymentIntent. This property is `null` until PaymentIntent confirmation is attempted.
    """
    livemode: bool
    """
    ...
    """
    Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Learn more about [storing information in metadata](https://paystack.com/docs/payments/payment-intents/creating-payment-intents#storing-information-in-metadata).
    """
    ...
    """
    The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts) for details.
    """
    ...
    """
    Status of this PaymentIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `requires_capture`, `canceled`, or `succeeded`. Read more about each PaymentIntent [status](https://paystack.com/docs/payments/intents#intent-statuses).
    """
    transfer_data: Optional[TransferData]
    """
    The data that automatically creates a Transfer after the payment finalizes. Learn more about the [use case for connected accounts](https://paystack.com/docs/payments/connected-accounts).
    """
    ...
    def _cls_cancel(
        ...
        """
        You can cancel a PaymentIntent object when it's in one of these statuses: requires_payment_method, requires_capture, requires_confirmation, requires_action or, [in rare cases](https://paystack.com/docs/payments/intents), processing.

        After it's canceled, no additional charges are made by the PaymentIntent and any operations on the PaymentIntent fail with an error. For PaymentIntents with a status of requires_capture, the remaining amount_capturable is automatically refunded.

        You can't cancel the PaymentIntent for a Checkout Session. [Expire the Checkout Session](https://paystack.com/docs/api/checkout/sessions/expire) instead.
        """
        return cast(
            "PaymentIntent",
            cls._static_request(
    ...
    def _cls_capture(
        ...
        Learn more about [separate authorization and capture](https://paystack.com/docs/payments/capture-later).
        """
        return cast(
            "PaymentIntent",
            cls._static_request(
    ...
    def _cls_confirm(
        ...
        using our [client SDKs](https://paystack.com/docs/paystack-js/reference#paystack-handle-card-payment)
        and the PaymentIntent's [client_secret](https://paystack.com/docs/api#payment_intent_object-client_secret).
    ...
    def create(
        ...
        After the PaymentIntent is created, attach a payment method and [confirm](https://paystack.com/docs/api/payment_intents/confirm)
        to continue the payment. Learn more about <a href="/docs/payments/payment-intents">the available payment flows
        with the Payment Intents API.

        When you use confirm=true during creation, it's equivalent to creating
        and confirming the PaymentIntent in the same call. You can use any parameters
        available in the [confirm API](https://paystack.com/docs/api/payment_intents/confirm) when you supply
        confirm=true.
        """
        return cast(
            "PaymentIntent",
    ...
    def _cls_increment_authorization(
        ...
        **params: Unpack["PaymentIntent.IncrementAuthorizationParams"],
        ...
        [PaymentIntent](https://paystack.com/docs/api/payment_intents/object). To be eligible, the
        PaymentIntent's status must be requires_capture and
        [incremental_authorization_supported](https://paystack.com/docs/api/charges/object#charge_object-payment_method_details-card_present-incremental_authorization_supported)
        must be true.
        ...
        [amount](https://paystack.com/docs/api/payment_intents/object#payment_intent_object-amount).
        If the incremental authorization fails, a
        [card_declined](https://paystack.com/docs/error-codes#card-declined) error returns, and no other
        ...
        Learn more about [incremental authorizations](https://paystack.com/docs/terminal/features/incremental-authorizations).
        """
        return cast(
            "PaymentIntent",
            cls._static_request(
    ...
    def modify(
        ...
        the [confirm API](https://paystack.com/docs/api/payment_intents/confirm) instead.
        """
    ...
    def retrieve(
        ...
        If you retrieve a PaymentIntent with a publishable key, it only returns a subset of properties. Refer to the [payment intent](https://paystack.com/docs/api#payment_intent_object) object reference for more details.
        """
    ...
    def search(
        ...
        """
        Search for PaymentIntents you've previously created using paystack's [Search Query Language](https://paystack.com/docs/search#search-query-language).
