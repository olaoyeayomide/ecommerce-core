...
if TYPE_CHECKING:
    from paystack._account import Account as AccountResource
    from paystack._customer import Customer
    from paystack.financial_connections._account_owner import AccountOwner
    from paystack.financial_connections._account_ownership import (
        AccountOwnership,
    )
...
class Account(ListableAPIResource["Account"]):
    """
    A Financial Connections Account represents an account that exists outside of paystack, to which you have been granted some degree of access.
    """
    ...
    class AccountHolder(paystackObject):
        account: Optional[ExpandableField["AccountResource"]]
        """
        The ID of the paystack account this account belongs to. Should only be present if `account_holder.type` is `account`.
        """
        customer: Optional[ExpandableField["Customer"]]
        """
        ID of the paystack customer this account belongs to. Present if and only if `account_holder.type` is `customer`.
        """
    ...
    class BalanceRefresh(paystackObject):
    ...
    class OwnershipRefresh(paystackObject):
        last_attempted_at: int
        """
        The time at which the last refresh attempt was initiated. Measured in seconds since the Unix epoch.
        """
    ...
    class TransactionRefresh(paystackObject):
        id: str
        """
    ...
    class ListParamsAccountHolder(TypedDict):
        ...
        """
        The ID of the paystack account whose accounts will be retrieved.
        """
        customer: NotRequired[str]
        """
        The ID of the paystack customer whose accounts will be retrieved.
        """
    ...
    """
    The [PaymentMethod type](https://paystack.com/docs/api/payment_methods/object#payment_method_object-type)(s) that can be created from this account.
    """
