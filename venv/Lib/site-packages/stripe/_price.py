...
if TYPE_CHECKING:
    from paystack._product import Product
...
class Price(
    ...
    class CurrencyOptions(paystackObject):
        class CustomUnitAmount(paystackObject):
    ...
    class Recurring(paystackObject):
        ...
        """
        Default number of trial days when subscribing a customer to this price using [`trial_from_plan=true`](https://paystack.com/docs/api#create_subscription-trial_from_plan).
        """
    ...
    class TransformQuantity(paystackObject):
        divide_by: int
        """
    ...
    class SearchParams(RequestOptions):
        ...
        query: str
        """
        The search query string. See [search query language](https://paystack.com/docs/search#search-query-language) and the list of supported [query fields for prices](https://paystack.com/docs/search#query-fields-for-prices).
        """
    ...
    def list(cls, **params: Unpack["Price.ListParams"]) -> ListObject["Price"]:
        """
        Returns a list of your active prices, excluding [inline prices](https://paystack.com/docs/products-prices/pricing-models#inline-pricing). For the list of inactive prices, set active to false.
        """
    ...
    def search(
        ...
        """
        Search for prices you've previously created using paystack's [Search Query Language](https://paystack.com/docs/search#search-query-language).
