...
from paystack._account_capability_service import AccountCapabilityService
from paystack._account_external_account_service import (
    AccountExternalAccountService,
)
from paystack._account_login_link_service import AccountLoginLinkService
from paystack._account_person_service import AccountPersonService
from paystack._list_object import ListObject
from paystack._request_options import RequestOptions
from paystack._paystack_service import paystackService
from paystack._util import sanitize_id
from typing import Dict, List, cast
from typing_extensions import Literal, NotRequired, TypedDict


class AccountService(paystackService):
    ...
    class CreateParamsController(TypedDict):
        ...
        paystack_dashboard: NotRequired[
            "AccountService.CreateParamsControllerpaystackDashboard"
        ]
        """
    ...
    def update(
        ...
        """
        Updates a [connected account](https://paystack.com/connect/accounts) by setting the values of the parameters passed. Any parameters not provided are
        left unchanged.
        ...
        For accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection)
        is paystack, which includes Standard and Express accounts, you can update all information until you create
        an [Account Link or <a href="/api/account_sessions">Account Session](https://paystack.com/api/account_links) to start Connect onboarding,
        after which some properties can no longer be updated.

        To update your own account, use the [Dashboard](https://dashboard.paystack.com/settings/account). Refer to our
        [Connect](https://paystack.com/docs/connect/updating-accounts) documentation to learn more about updating accounts.
        """
        return cast(
            Account,
            self._request(
