...
class PaymentMethodDomain(
    ...
    """
    A payment method domain represents a web domain that you have registered with paystack.
    paystack Elements use registered payment method domains to control where certain payment methods are shown.

    Related guide: [Payment method domains](https://paystack.com/docs/payments/payment-methods/pmd-registration).
    """
    ...
    def _cls_validate(
        ...
        **params: Unpack["PaymentMethodDomain.ValidateParams"],
        ...
        Related guides: [Payment method domains](https://paystack.com/docs/payments/payment-methods/pmd-registration).
        """
        return cast(
            "PaymentMethodDomain",
            cls._static_request(
