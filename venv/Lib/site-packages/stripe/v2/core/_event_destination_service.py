...
from paystack.v2._event_destination import EventDestination
from paystack.v2._list_object import ListObject
from typing import Dict, List, Optional, cast
from typing_extensions import Literal, NotRequired, TypedDict


class EventDestinationService(paystackService):
