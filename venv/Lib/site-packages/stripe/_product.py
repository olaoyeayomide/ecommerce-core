...
if TYPE_CHECKING:
    ...
    from paystack._product_feature import ProductFeature
    from paystack._tax_code import TaxCode
...
class Product(
    ...
    They can be used in conjunction with [Prices](https://paystack.com/docs/api#prices) to configure pricing in Payment Links, Checkout, and Subscriptions.

    Related guides: [Set up a subscription](https://paystack.com/docs/billing/subscriptions/set-up-subscription),
    [share a Payment Link](https://paystack.com/docs/payment-links),
    [accept payments with Checkout](https://paystack.com/docs/payments/accept-a-payment#create-product-prices-upfront),
    and more about [Products and Prices](https://paystack.com/docs/products-prices/overview)
    """

    OBJECT_NAME: ClassVar[Literal["product"]] = "product"

    class MarketingFeature(paystackObject):
        name: Optional[str]
        """
        The marketing feature name. Up to 80 characters long.
        """

    class PackageDimensions(paystackObject):
        height: float
        """
        Height, in inches.
        """
    ...
    class CreateFeatureParams(RequestOptions):
        ...
        """
        The ID of the [Feature](https://paystack.com/docs/api/entitlements/feature) object attached to this product.
        """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        Data used to generate a new [Price](https://paystack.com/docs/api/prices) object. This Price will be set as the default price for this product.
        """
        ...
        id: NotRequired[str]
        """
        An identifier will be randomly generated by paystack. You can optionally override this ID, but the ID must be unique across all products in your paystack account.
        """
        ...
        """
        A list of up to 15 marketing features for this product. These are displayed in [pricing tables](https://paystack.com/docs/payments/checkout/pricing-table).
        """
    ...
    class CreateParamsDefaultPriceData(TypedDict):
        ...
        """
        Prices defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://paystack.com/docs/currencies).
        """
    ...
    class ListParams(RequestOptions):
        ...
        """
        Only return products with the given IDs. Cannot be used with [starting_after](https://paystack.com/docs/api#list_products-starting_after) or [ending_before](https://paystack.com/docs/api#list_products-ending_before).
        """
        limit: NotRequired[int]
        """
        A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
    ...
    class ModifyParams(RequestOptions):
        ...
        """
        The ID of the [Price](https://paystack.com/docs/api/prices) object that is the default price for this product.
        """
    ...
    class SearchParams(RequestOptions):
        ...
        query: str
        """
        The search query string. See [search query language](https://paystack.com/docs/search#search-query-language) and the list of supported [query fields for products](https://paystack.com/docs/search#query-fields-for-products).
        """
    ...
    def retrieve(
        ...
        """
        Retrieves the details of an existing product. Supply the unique product ID from either a product creation request or the product list, and paystack will return the corresponding product information.
        """
    ...
    def search(
        ...
        """
        Search for products you've previously created using paystack's [Search Query Language](https://paystack.com/docs/search#search-query-language).
