...
class Capability(UpdateableAPIResource["Capability"]):
    """
    This is an object representing a capability for a paystack account.

    Related guide: [Account capabilities](https://paystack.com/docs/connect/account-capabilities)
    """
    ...
    class Requirements(paystackObject):
        ...
        """
        Description of why the capability is disabled. [Learn more about handling verification issues](https://paystack.com/docs/connect/handling-api-verification).
        """
        errors: List[Error]
        """
        Fields that are `currently_due` and need to be collected again because validation or verification failed.
