...
class TaxId(
    ...
    """
    You can add one or multiple tax IDs to a [customer](https://paystack.com/docs/api/customers) or account.
    Customer and account tax IDs get displayed on related invoices and credit notes.

    Related guides: [Customer tax identification numbers](https://paystack.com/docs/billing/taxes/tax-ids), [Account tax IDs](https://paystack.com/docs/invoicing/connect#account-tax-ids)
    """
