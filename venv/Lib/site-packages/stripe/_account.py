...
from paystack._createable_api_resource import CreateableAPIResource
from paystack._deletable_api_resource import DeletableAPIResource
from paystack._expandable_field import ExpandableField
from paystack._list_object import ListObject
from paystack._listable_api_resource import ListableAPIResource
from paystack._nested_resource_class_methods import nested_resource_class_methods
from paystack._oauth import OAuth
from paystack._person import Person
from paystack._request_options import RequestOptions
from paystack._paystack_object import paystackObject
from paystack._updateable_api_resource import UpdateableAPIResource
from paystack._util import class_method_variant, sanitize_id
...
if TYPE_CHECKING:
    from paystack._bank_account import BankAccount
    from paystack._capability import Capability
    from paystack._card import Card
    from paystack._file import File
    from paystack._login_link import LoginLink
    from paystack._tax_id import TaxId
...
class Account(
    ...
    """
    This is an object representing a paystack account. You can retrieve it to see
    properties on the account like its current requirements or if the account is
    enabled to make live charges or receive payouts.

    For accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection)
    is `application`, which includes Custom accounts, the properties below are always
    returned.

    For accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection)
    is `paystack`, which includes Standard and Express accounts, some properties are only returned
    until you create an [Account Link](https://paystack.com/api/account_links) or [Account Session](https://paystack.com/api/account_sessions)
    to start Connect Onboarding. Learn about the [differences between accounts](https://paystack.com/connect/accounts).
    """

    OBJECT_NAME: ClassVar[Literal["account"]] = "account"

    class BusinessProfile(paystackObject):
        class AnnualRevenue(paystackObject):
            amount: Optional[int]
            """
            A non-negative integer representing the amount in the [smallest currency unit](https://paystack.com/currencies#zero-decimal).
            """
            currency: Optional[str]
            """
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
            """
        ...
        class MonthlyEstimatedRevenue(paystackObject):
            amount: int
            """
            A non-negative integer representing how much to charge in the [smallest currency unit](https://paystack.com/currencies#zero-decimal).
            """
            currency: str
            """
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies).
        ...
        class SupportAddress(paystackObject):
            city: Optional[str]
            """
        ...
        mcc: Optional[str]
        """
        [The merchant category code for the account](https://paystack.com/connect/setting-mcc). MCCs are used to classify businesses based on the goods or services they provide.
        """
        ...
        """
        Internal-only description of the product sold or service provided by the business. It's used by paystack for risk and underwriting purposes.
        """
    ...
    class Capabilities(paystackObject):
    ...
    class Company(paystackObject):
        class Address(paystackObject):
            city: Optional[str]
            """
            City, district, suburb, town, or village.
            """
        ...
        class AddressKana(paystackObject):
            city: Optional[str]
            """
            City/Ward.
            """
        ...
        class AddressKanji(paystackObject):
            city: Optional[str]
            """
            City/Ward.
            """
        ...
        class OwnershipDeclaration(paystackObject):
            date: Optional[int]
            """
        ...
        class Verification(paystackObject):
            class Document(paystackObject):
                back: Optional[ExpandableField["File"]]
                """
                The back of a document returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `additional_verification`.
                """
                ...
                """
                The front of a document returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `additional_verification`.
                """
        ...
        """
        Whether the company's directors have been provided. This Boolean will be `true` if you've manually indicated that all directors are provided via [the `directors_provided` parameter](https://paystack.com/docs/api/accounts/update#update_account-company-directors_provided).
        """
        executives_provided: Optional[bool]
        """
        Whether the company's executives have been provided. This Boolean will be `true` if you've manually indicated that all executives are provided via [the `executives_provided` parameter](https://paystack.com/docs/api/accounts/update#update_account-company-executives_provided), or if paystack determined that sufficient executives were provided.
        """
        ...
        """
        Whether the company's owners have been provided. This Boolean will be `true` if you've manually indicated that all owners are provided via [the `owners_provided` parameter](https://paystack.com/docs/api/accounts/update#update_account-company-owners_provided), or if paystack determined that sufficient owners were provided. paystack determines ownership requirements using both the number of owners provided and their total percent ownership (calculated by adding the `percent_ownership` of each owner together).
        """
        ownership_declaration: Optional[OwnershipDeclaration]
        """
        This hash is used to attest that the beneficial owner information provided to paystack is both current and correct.
        """
        phone: Optional[str]
        """
        ...
        """
        The category identifying the legal structure of the company or legal entity. See [Business structure](https://paystack.com/docs/connect/identity-verification#business-structure) for more details.
        """
    ...
    class Controller(paystackObject):
        class Fees(paystackObject):
            payer: Literal[
                "account",
                "application",
                "application_custom",
            ...
            """
            A value indicating the responsible payer of a bundle of paystack fees for pricing-control eligible products on this account. Learn more about [fee behavior on connected accounts](https://docs.paystack.com/connect/direct-charges-fee-payer-behavior).
            """

        class Losses(paystackObject):
            payments: Literal["application", "paystack"]
            """
            A value indicating who is liable when this account can't pay back negative balances from payments.
            """

        class paystackDashboard(paystackObject):
            type: Literal["express", "full", "none"]
            """
            A value indicating the paystack dashboard this account has access to independent of the Connect application.
            """

        fees: Optional[Fees]
        is_controller: Optional[bool]
        """
        `true` if the Connect application retrieving the resource controls the account and can therefore exercise [platform controls](https://paystack.com/docs/connect/platform-controls-for-standard-accounts). Otherwise, this field is null.
        """
        losses: Optional[Losses]
        requirement_collection: Optional[Literal["application", "paystack"]]
        """
        A value indicating responsibility for collecting requirements on this account. Only returned when the Connect application retrieving the resource controls the account.
        """
        paystack_dashboard: Optional[paystackDashboard]
        ...
        _inner_class_types = {
            "fees": Fees,
            "losses": Losses,
            "paystack_dashboard": paystackDashboard,
        }

    class FutureRequirements(paystackObject):
        class Alternative(paystackObject):
    ...
    class Groups(paystackObject):
        payments_pricing: Optional[str]
        """
        The group the account is in to determine their payments pricing, and null if the account is on customized pricing. [See the Platform pricing tool documentation](https://paystack.com/docs/connect/platform-pricing-tools) for details.
        """

    class Requirements(paystackObject):
        class Alternative(paystackObject):
            alternative_fields_due: List[str]
            """
            Fields that can be provided to satisfy all fields in `original_fields_due`.
    ...
    class Settings(paystackObject):
        class BacsDebitPayments(paystackObject):
            display_name: Optional[str]
            """
            The Bacs Direct Debit display name for this account. For payments made with Bacs Direct Debit, this name appears on the mandate as the statement descriptor. Mobile banking apps display it as the name of the business. To use custom branding, set the Bacs Direct Debit Display Name during or right after creation. Custom branding incurs an additional monthly fee for the platform. The fee appears 5 business days after requesting Bacs. If you don't set the display name before requesting Bacs capability, it's automatically set as "paystack" and the account is onboarded to paystack branding, which is free.
            """
        ...
        class Branding(paystackObject):
            icon: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) An icon for the account. Must be square and at least 128px x 128px.
            """
            logo: Optional[ExpandableField["File"]]
            """
            (ID of a [file upload](https://paystack.com/docs/guides/file-upload)) A logo for the account that will be used in Checkout instead of the icon and without the account's name next to it if provided. Must be at least 128px x 128px.
            """
        ...
        class CardIssuing(paystackObject):
            class TosAcceptance(paystackObject):
                date: Optional[int]
                """
        ...
        class CardPayments(paystackObject):
            class DeclineOn(paystackObject):
                avs_failure: bool
                """
                Whether paystack automatically declines charges with an incorrect ZIP or postal code. This setting only applies when a ZIP or postal code is provided and they fail bank verification.
                """
                cvc_failure: bool
                """
                Whether paystack automatically declines charges with an incorrect CVC. This setting only applies when a CVC is provided and it fails bank verification.
                """
        ...
        class Dashboard(paystackObject):
            display_name: Optional[str]
            """
            The display name for this account. This is used on the paystack Dashboard to differentiate between accounts.
            """
            timezone: Optional[str]
            """
            The timezone used in the paystack Dashboard for this account. A list of possible time zone values is maintained at the [IANA Time Zone Database](http://www.iana.org/time-zones).
            """

        class Invoices(paystackObject):
            default_account_tax_ids: Optional[List[ExpandableField["TaxId"]]]
            """
            The list of default Account Tax IDs to automatically include on invoices. Account Tax IDs get added when an invoice is finalized.
            """

        class Payments(paystackObject):
            ...
            """
            The Kana variation of `statement_descriptor` used for charges in Japan. Japanese statement descriptors have [special requirements](https://docs.paystack.com/get-started/account/statement-descriptors#set-japanese-statement-descriptors).
            """
            statement_descriptor_kanji: Optional[str]
            """
            The Kanji variation of `statement_descriptor` used for charges in Japan. Japanese statement descriptors have [special requirements](https://docs.paystack.com/get-started/account/statement-descriptors#set-japanese-statement-descriptors).
            """
            statement_descriptor_prefix_kana: Optional[str]
            """
            The Kana variation of `statement_descriptor_prefix` used for card charges in Japan. Japanese statement descriptors have [special requirements](https://docs.paystack.com/get-started/account/statement-descriptors#set-japanese-statement-descriptors).
            """
            statement_descriptor_prefix_kanji: Optional[str]
            """
            The Kanji variation of `statement_descriptor_prefix` used for card charges in Japan. Japanese statement descriptors have [special requirements](https://docs.paystack.com/get-started/account/statement-descriptors#set-japanese-statement-descriptors).
            """

        class Payouts(paystackObject):
            class Schedule(paystackObject):
                delay_days: int
                """
            ...
            """
            A Boolean indicating if paystack should try to reclaim negative balances from an attached bank account. See [Understanding Connect account balances](https://paystack.com/connect/account-balances) for details. The default value is `false` when [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts, otherwise `true`.
            """
            schedule: Schedule
            statement_descriptor: Optional[str]
            """
        ...
        class SepaDebitPayments(paystackObject):
            creditor_id: Optional[str]
            """
            SEPA creditor identifier that identifies the company making the payment.
            """

        class Treasury(paystackObject):
            class TosAcceptance(paystackObject):
                date: Optional[int]
                """
                The Unix timestamp marking when the account representative accepted the service agreement.
    ...
    class CreateExternalAccountParams(RequestOptions):
        ...
        """
        Please refer to full [documentation](https://paystack.com/docs/api) instead.
        """
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
        """
    ...
    class CreateExternalAccountParamsBankAccount(TypedDict):
        ...
        """
        The currency the bank account is in. This must be a country/currency pairing that [paystack supports.](docs/payouts)
        """
    ...
    class CreateExternalAccountParamsCard(TypedDict):
        ...
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
        """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        An [account token](https://paystack.com/docs/api#create_account_token), used to securely provide details to the account.
        """
        ...
        """
        The business type. Once you create an [Account Link](https://paystack.com/api/account_links) or [Account Session](https://paystack.com/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
        """
        ...
        requirements and paystack has verified them. An account might have some
        of its requested capabilities be active and some be inactive.

        Required when [account.controller.paystack_dashboard.type](https://paystack.com/api/accounts/create#create_account-controller-dashboard-type)
        is `none`, which includes Custom accounts.
        """
        company: NotRequired["Account.CreateParamsCompany"]
        """
        Information about the company or business. This field is available for any `business_type`. Once you create an [Account Link](https://paystack.com/api/account_links) or [Account Session](https://paystack.com/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
        """
        ...
        """
        The country in which the account holder resides, or in which the business is legally established. This should be an ISO 3166-1 alpha-2 country code. For example, if you are in the United States and the business for which you're creating an account is legally represented in Canada, you would use `CA` as the country for the account being created. Available countries include [paystack's global markets](https://paystack.com/global) as well as countries where [cross-border payouts](https://paystack.com/docs/connect/cross-border-payouts) are supported.
        """
        default_currency: NotRequired[str]
        """
        Three-letter ISO currency code representing the default currency for the account. This must be a currency that [paystack supports in the account's country](https://docs.paystack.com/payouts).
        """
        ...
        """
        The email address of the account holder. This is only to make the account easier to identify to you. If [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts, paystack doesn't email the account without your consent.
        """
        expand: NotRequired[List[str]]
        """
        Specifies which fields in the response should be expanded.
        ...
        """
        A card or bank account to attach to the account for receiving [payouts](https://paystack.com/connect/bank-debit-card-payouts) (you won't be able to use it for top-ups). You can provide either a token, like the ones returned by [paystack.js](https://paystack.com/js), or a dictionary, as documented in the `external_account` parameter for [bank account](https://paystack.com/api#account_create_bank_account) creation.

        By default, providing an external account sets it as the new default external account for its currency, and deletes the old default if one exists. To add additional external accounts without replacing the existing default for the currency, use the [bank account](https://paystack.com/api#account_create_bank_account) or [card creation](https://paystack.com/api#account_create_card) APIs. After you create an [Account Link](https://paystack.com/api/account_links) or [Account Session](https://paystack.com/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
        """
        ...
        """
        Information about the person represented by the account. This field is null unless `business_type` is set to `individual`. Once you create an [Account Link](https://paystack.com/api/account_links) or [Account Session](https://paystack.com/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
        """
        ...
        """
        Options for customizing how the account functions within paystack.
        """
        tos_acceptance: NotRequired["Account.CreateParamsTosAcceptance"]
        """
        Details on the account's acceptance of the [paystack Services Agreement](https://paystack.com/connect/updating-accounts#tos-acceptance). This property can only be updated for accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts. This property defaults to a `full` service agreement when empty.
        """
        type: NotRequired[Literal["custom", "express", "standard"]]
        """
        The type of paystack account to create. May be one of `custom`, `express` or `standard`.
        """
    ...
    class CreateParamsBusinessProfile(TypedDict):
        ...
        """
        Internal-only description of the product sold by, or service provided by, the business. Used by paystack for risk and underwriting purposes.
        """
    ...
    class CreateParamsCompany(TypedDict):
        ...
        """
        Whether the company's directors have been provided. Set this Boolean to `true` after creating all the company's directors with [the Persons API](https://paystack.com/api/persons) for accounts with a `relationship.director` requirement. This value is not automatically set to `true` after creating directors, so it needs to be updated to indicate all directors have been provided.
        """
        executives_provided: NotRequired[bool]
        """
        Whether the company's executives have been provided. Set this Boolean to `true` after creating all the company's executives with [the Persons API](https://paystack.com/api/persons) for accounts with a `relationship.executive` requirement.
        """
        ...
        """
        Whether the company's owners have been provided. Set this Boolean to `true` after creating all the company's owners with [the Persons API](https://paystack.com/api/persons) for accounts with a `relationship.owner` requirement.
        """
        ...
        """
        The category identifying the legal structure of the company or legal entity. See [Business structure](https://paystack.com/connect/identity-verification#business-structure) for more details. Pass an empty string to unset this value.
        """
    ...
    class CreateParamsCompanyVerificationDocument(TypedDict):
        ...
        """
        The back of a document returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
        """
        front: NotRequired[str]
        """
        The front of a document returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
        """

    class CreateParamsController(TypedDict):
        fees: NotRequired["Account.CreateParamsControllerFees"]
        """
        A hash of configuration for who pays paystack fees for product usage on this account.
        """
        losses: NotRequired["Account.CreateParamsControllerLosses"]
        """
        A hash of configuration for products that have negative balance liability, and whether paystack or a Connect application is responsible for them.
        """
        requirement_collection: NotRequired[Literal["application", "paystack"]]
        """
        A value indicating responsibility for collecting updated information when requirements on the account are due or change. Defaults to `paystack`.
        """
        paystack_dashboard: NotRequired[
            "Account.CreateParamsControllerpaystackDashboard"
        ]
        """
        A hash of configuration for paystack-hosted dashboards.
        """

    class CreateParamsControllerFees(TypedDict):
        payer: NotRequired[Literal["account", "application"]]
        """
        A value indicating the responsible payer of paystack fees on this account. Defaults to `account`. Learn more about [fee behavior on connected accounts](https://docs.paystack.com/connect/direct-charges-fee-payer-behavior).
        """

    class CreateParamsControllerLosses(TypedDict):
        payments: NotRequired[Literal["application", "paystack"]]
        """
        A value indicating who is liable when this account can't pay back negative balances resulting from payments. Defaults to `paystack`.
        """

    class CreateParamsControllerpaystackDashboard(TypedDict):
        type: NotRequired[Literal["express", "full", "none"]]
        """
        Whether this account should have access to the full paystack Dashboard (`full`), to the Express Dashboard (`express`), or to no paystack-hosted dashboard (`none`). Defaults to `full`.
        """
    ...
    class CreateParamsDocuments(TypedDict):
        ...
        """
        One or more documents that support the [Bank account ownership verification](https://support.paystack.com/questions/bank-account-ownership-verification) requirement. Must be a document associated with the account's primary active bank account that displays the last 4 digits of the account number, either a statement or a check.
        """
    ...
    class CreateParamsDocumentsBankAccountOwnershipVerification(TypedDict):
        ...
        """
        One or more document ids returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `account_requirement`.
        """
    ...
    class CreateParamsIndividual(TypedDict):
        ...
        """
        The government-issued ID number of the individual, as appropriate for the representative's country. (Examples are a Social Security Number in the U.S., or a Social Insurance Number in Canada). Instead of the number itself, you can also provide a [PII token created with paystack.js](https://paystack.com/js/tokens/create_token?type=pii).
        """
    ...
    class CreateParamsIndividualVerificationAdditionalDocument(TypedDict):
        back: NotRequired[str]
        """
        The back of an ID returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
        """
        front: NotRequired[str]
        """
        The front of an ID returned by a [file upload](https://paystack.com/docs/api#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
        """
    ...
    class CreateParamsSettingsCardIssuing(TypedDict):
        ...
        """
        Details on the account's acceptance of the [paystack Issuing Terms and Disclosures](https://paystack.com/issuing/connect/tos_acceptance).
        """
    ...
    class CreateParamsSettingsPayouts(TypedDict):
        ...
        """
        A Boolean indicating whether paystack should try to reclaim negative balances from an attached bank account. For details, see [Understanding Connect Account Balances](https://paystack.com/connect/account-balances).
        """
        schedule: NotRequired["Account.CreateParamsSettingsPayoutsSchedule"]
        """
        Details on when funds from charges are available, and when they are paid out to an external account. For details, see our [Setting Bank and Debit Card Payouts](https://paystack.com/connect/bank-transfers#payout-information) documentation.
        """
        statement_descriptor: NotRequired[str]
        """
        The text that appears on the bank account statement for payouts. If not set, this defaults to the platform's bank descriptor as set in the Dashboard.
    ...
    class CreateParamsSettingsPayoutsSchedule(TypedDict):
        ...
        """
        The number of days charge funds are held before being paid out. May also be set to `minimum`, representing the lowest available value for the account country. Default is `minimum`. The `delay_days` parameter remains at the last configured value if `interval` is `manual`. [Learn more about controlling payout delay days](https://paystack.com/connect/manage-payout-schedule).
        """
    ...
    class CreateParamsSettingsTreasury(TypedDict):
        ...
        """
        Details on the account's acceptance of the paystack Treasury Services Agreement.
        """
    ...
    class CreatePersonParams(RequestOptions):
        ...
        """
        Details on the legal guardian's or authorizer's acceptance of the required paystack agreements.
        """
        ...
        id_number: NotRequired[str]
        """
        The person's ID number, as appropriate for their country. For example, a social security number in the U.S., social insurance number in Canada, etc. Instead of the number itself, you can also provide a [PII token provided by paystack.js](https://docs.paystack.com/js/tokens/create_token?type=pii).
        """
        id_number_secondary: NotRequired[str]
        """
        The person's secondary ID number, as appropriate for their country, will be used for enhanced verification checks. In Thailand, this would be the laser code found on the back of an ID card. Instead of the number itself, you can also provide a [PII token provided by paystack.js](https://docs.paystack.com/js/tokens/create_token?type=pii).
        """
        last_name: NotRequired[str]
        """
        ...
        """
        A [person token](https://docs.paystack.com/connect/account-tokens), used to securely provide details to the person.
        """
        phone: NotRequired[str]
        """
    ...
    class CreatePersonParamsAdditionalTosAcceptances(TypedDict):
        ...
        """
        Details on the legal guardian's acceptance of the main paystack service agreement.
        """
    ...
    class ModifyExternalAccountParamsDocuments(TypedDict):
        ...
        """
        One or more documents that support the [Bank account ownership verification](https://support.paystack.com/questions/bank-account-ownership-verification) requirement. Must be a document associated with the bank account that displays the last 4 digits of the account number, either a statement or a check.
        """
    ...
    """
    The business type. After you create an [Account Link](https://paystack.com/api/account_links) or [Account Session](https://paystack.com/api/account_sessions), this property is only returned for accounts where [controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
    """
    ...
    """
    Three-letter ISO currency code representing the default currency for the account. This must be a currency that [paystack supports in the account's country](https://paystack.com/docs/payouts).
    """
    details_submitted: Optional[bool]
    """
    Whether account details have been submitted. Accounts with paystack Dashboard access, which includes Standard accounts, cannot receive payouts before this is true. Accounts where this is false should be directed to [an onboarding flow](https://paystack.com/connect/onboarding) to finish submitting account details.
    """
    email: Optional[str]
    """
    An email address associated with the account. It's not used for authentication and paystack doesn't market to this field without explicit approval from the platform.
    """
    ...
    """
    This is an object representing a person associated with a paystack account.

    A platform cannot access a person for an account where [account.controller.requirement_collection](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection) is `paystack`, which includes Standard and Express accounts, after creating an Account Link or Account Session to start Connect onboarding.

    See the [Standard onboarding](https://paystack.com/connect/standard-accounts) or [Express onboarding](https://paystack.com/connect/express-accounts) documentation for information about prefilling information and account onboarding steps. Learn more about [handling identity verification with the API](https://paystack.com/connect/handling-api-verification#person-information).
    """
    ...
    """
    The paystack account type. Can be `standard`, `express`, `custom`, or `none`.
    """
    ...
    def create(cls, **params: Unpack["Account.CreateParams"]) -> "Account":
        """
        With [Connect](https://paystack.com/docs/connect), you can create paystack accounts for your users.
        To do this, you'll first need to [register your platform](https://dashboard.paystack.com/account/applications/settings).

        If you've already collected information for your connected accounts, you [can prefill that information](https://paystack.com/docs/connect/best-practices#onboarding) when
    ...
    def _cls_delete(
        ...
        """
        With [Connect](https://paystack.com/connect), you can delete accounts you manage.

        Test-mode accounts can be deleted at any time.

        Live-mode accounts where paystack is responsible for negative account balances cannot be deleted, which includes Standard accounts. Live-mode accounts where your platform is liable for negative account balances, which includes Custom and Express accounts, can be deleted when all [balances](https://paystack.com/api/balance/balance_object) are zero.

        If you want to delete your own account, use the [account information tab in your account settings](https://dashboard.paystack.com/settings/account) instead.
        """
    ...
    def list(
        ...
        """
        Returns a list of accounts connected to your platform via [Connect](https://paystack.com/docs/connect). If you're not a platform, the list is empty.
        """
    ...
    def _cls_reject(
        ...
        """
        With [Connect](https://paystack.com/connect), you can reject accounts that you have flagged as suspicious.
    ...
    def deauthorize(self, **params):
        params["paystack_user_id"] = self.id
    ...
    def modify_external_account(
        ...
        **params: Unpack["Account.ModifyExternalAccountParams"],
        ...
        You can only update bank accounts when [account.controller.requirement_collection is application, which includes <a href="/connect/custom-accounts">Custom accounts](https://paystack.com/api/accounts/object#account_object-controller-requirement_collection).
    ...
    def create_login_link(
        ...
        You can only create login links for accounts that use the [Express Dashboard](https://paystack.com/connect/express-dashboard) and are connected to your platform.
        """
        return cast(
            "LoginLink",
            cls._static_request(
