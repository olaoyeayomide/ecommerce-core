...
class ShippingRate(
    ...
    applied to a purchase. For more information, see [Charge for shipping](https://paystack.com/docs/payments/during-payment/charge-shipping).
    """

    OBJECT_NAME: ClassVar[Literal["shipping_rate"]] = "shipping_rate"

    class DeliveryEstimate(paystackObject):
        class Maximum(paystackObject):
    ...
    class FixedAmount(paystackObject):
