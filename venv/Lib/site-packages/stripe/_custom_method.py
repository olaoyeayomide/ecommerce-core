...
# TODO(major): 1704.
@_util.deprecated(
    "the custom_method class decorator will be removed in a future version of paystack-python. Define custom methods directly and use paystackObject._static_request within."
)
def custom_method(
    name: str,
    http_verb: str,
