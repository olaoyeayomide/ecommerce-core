...
class PaymentLink(
    ...
    class PaymentIntentData(paystackObject):
        ...
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that will set metadata on [Payment Intents](https://paystack.com/docs/api/payment_intents) generated from this payment link.
        """
    ...
    class Restrictions(paystackObject):
        class CompletedSessions(paystackObject):
            count: int
            """
    ...
    class SubscriptionData(paystackObject):
        ...
        metadata: Dict[str, str]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that will set metadata on [Subscriptions](https://paystack.com/docs/api/subscriptions) generated from this payment link.
        """
    ...
    class CreateParams(RequestOptions):
        ...
        """
        The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's paystack account. Can only be applied when there are no line items with recurring prices.
        """
        application_fee_percent: NotRequired[float]
        """
        A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice total that will be transferred to the application owner's paystack account. There must be at least 1 line item with a recurring price to use this field.
        """
        ...
        """
        Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://paystack.com/docs/currencies) and supported by each line item's price.
        """
        ...
        """
        Configures whether [checkout sessions](https://paystack.com/docs/api/checkout/sessions) created by this payment link create a [Customer](https://paystack.com/docs/api/customers).
        """
        ...
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`. Metadata associated with this Payment Link will automatically be copied to [checkout sessions](https://paystack.com/docs/api/checkout/sessions) created by this payment link.
        """
        ...
        """
        The list of payment method types that customers can use. If no value is passed, paystack will dynamically show relevant payment methods from your [payment method settings](https://dashboard.paystack.com/settings/payment_methods) (20+ payment methods [supported](https://paystack.com/docs/payments/payment-methods/integration-options#payment-method-product-support)).
        """
        ...
        """
        The shipping rate options to apply to [checkout sessions](https://paystack.com/docs/api/checkout/sessions) created by this payment link.
        """
        submit_type: NotRequired[Literal["auto", "book", "donate", "pay"]]
        """
        Describes the type of transaction being performed in order to customize relevant text on the page, such as the submit button. Changing this value will also affect the hostname in the [url](https://paystack.com/docs/api/payment_links/payment_links/object#url) property (example: `donate.paystack.com`).
        """
    ...
    class CreateParamsAfterCompletionRedirect(TypedDict):
        url: str
        """
        The URL the customer will be redirected to after the purchase is complete. You can embed `{CHECKOUT_SESSION_ID}` into the URL to have the `id` of the completed [checkout session](https://paystack.com/docs/api/checkout/sessions/object#checkout_session_object-id) included.
        """
    ...
    class CreateParamsLineItem(TypedDict):
        ...
        price: str
        """
        The ID of the [Price](https://paystack.com/docs/api/prices) or [Plan](https://paystack.com/docs/api/plans) object.
        """
        quantity: int
        """
    ...
    class CreateParamsPaymentIntentData(TypedDict):
        ...
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that will declaratively set metadata on [Payment Intents](https://paystack.com/docs/api/payment_intents) generated from this payment link. Unlike object-level metadata, this field is declarative. Updates will clear prior values.
        """
        setup_future_usage: NotRequired[Literal["off_session", "on_session"]]
        """
        Indicates that you intend to [make future payments](https://paystack.com/docs/payments/payment-intents#future-usage) with the payment method collected by this Checkout Session.
    ...
    class CreateParamsSubscriptionData(TypedDict):
        ...
        metadata: NotRequired[Dict[str, str]]
        """
        Set of [key-value pairs](https://paystack.com/docs/api/metadata) that will declaratively set metadata on [Subscriptions](https://paystack.com/docs/api/subscriptions) generated from this payment link. Unlike object-level metadata, this field is declarative. Updates will clear prior values.
        """
    ...
    class ModifyParams(RequestOptions):
        ...
        """
        The list of payment method types that customers can use. Pass an empty string to enable dynamic payment methods that use your [payment method settings](https://dashboard.paystack.com/settings/payment_methods).
        """
    ...
    """
    The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's paystack account.
    """
    application_fee_percent: Optional[float]
    """
    This represents the percentage of the subscription invoice total that will be transferred to the application owner's paystack account.
    """
    ...
    """
    The account on behalf of which to charge. See the [Connect documentation](https://support.paystack.com/questions/sending-invoices-on-behalf-of-connected-accounts) for details.
    """
    ...
    """
    The list of payment method types that customers can use. When `null`, paystack will dynamically show relevant payment methods you've enabled in your [payment method settings](https://dashboard.paystack.com/settings/payment_methods).
    """
