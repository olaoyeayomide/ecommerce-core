...
class Registration(
    ...
    """
    A Tax `Registration` lets us know that your business is registered to collect tax on payments within a region, enabling you to [automatically collect tax](https://paystack.com/docs/tax).

    paystack doesn't register on your behalf with the relevant authorities when you create a Tax `Registration` object. For more information on how to register to collect tax, see [our guide](https://paystack.com/docs/tax/registering).

    Related guide: [Using the Registrations API](https://paystack.com/docs/tax/registrations-api)
    """

    OBJECT_NAME: ClassVar[Literal["tax.registration"]] = "tax.registration"

    class CountryOptions(paystackObject):
        class Ae(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class At(paystackObject):
            class Standard(paystackObject):
        ...
        class Au(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Be(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Bh(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class By(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Ca(paystackObject):
            class ProvinceStandard(paystackObject):
                province: str
                """
        ...
        class Ch(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Cl(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Co(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Cr(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Cy(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Ec(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Ee(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Eg(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Es(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Gb(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Ge(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Gr(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Id(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Ie(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Is(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class It(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Jp(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Ke(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Kr(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Kz(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Lt(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Ma(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Md(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Mt(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Mx(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class My(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Ng(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Nl(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class No(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Nz(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Om(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Pl(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Rs(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Ru(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Sa(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Se(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Sg(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """

        class Si(paystackObject):
            class Standard(paystackObject):
                place_of_supply_scheme: Literal["small_seller", "standard"]
                """
                Place of supply scheme used in an EU standard registration.
        ...
        class Th(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Tr(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Tz(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Us(paystackObject):
            class LocalAmusementTax(paystackObject):
                jurisdiction: str
                """
                A [FIPS code](https://www.census.gov/library/reference/code-lists/ansi.html) representing the local jurisdiction.
                """

            class LocalLeaseTax(paystackObject):
                jurisdiction: str
                """
                A [FIPS code](https://www.census.gov/library/reference/code-lists/ansi.html) representing the local jurisdiction.
                """

            class StateSalesTax(paystackObject):
                class Election(paystackObject):
        ...
        class Uz(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Vn(paystackObject):
            type: Literal["simplified"]
            """
            Type of registration in `country`.
            """

        class Za(paystackObject):
            type: Literal["standard"]
            """
            Type of registration in `country`.
            """
